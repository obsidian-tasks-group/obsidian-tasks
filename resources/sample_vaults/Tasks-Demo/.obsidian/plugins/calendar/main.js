...
function appHasPeriodicNotesPluginLoaded() {
    ...
    return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) === null || _a === void 0 ? void 0 : _a.weekly) === null || _b === void 0
            ? void 0
            : _b.enabled)
    );
}
...
function getWordCount(text) {
    ...
    const pattern = new RegExp(
        [`(?:[0-9]+(?:(?:,|\\.)[0-9]+)*|[\\-${spaceDelimitedChars}])+`, nonSpaceDelimitedWords].join('|'),
        'g',
    );
    ...
    return {
        c() {
            ...
            attr(
                svg,
                'class',
                (svg_class_value = '' + (null_to_empty(`hollow ${/*className*/ ctx[0]}`) + ' svelte-1widvzq')),
            );
    ...
    return {
        c() {
            ...
            attr(
                svg,
                'class',
                (svg_class_value = '' + (null_to_empty(`dot filled ${/*className*/ ctx[0]}`) + ' svelte-1widvzq')),
            );
            attr(svg, 'viewBox', '0 0 6 6');
            attr(svg, 'xmlns', 'http://www.w3.org/2000/svg');
            toggle_class(svg, 'active', /*isActive*/ ctx[2]);
...
function create_if_block$1(ctx) {
    ...
    return {
        ...
        p(new_ctx, dirty) {
            ...
            if (dirty & /*metadata*/ 1 && promise !== (promise = /*metadata*/ ctx[0]) && handle_promise(promise, info));
            else {
...
function create_default_slot$1(ctx) {
    ...
    return {
                ...
                dispose = [
                    listen(div1, 'click', function () {
                        if (is_function(/*onClick*/ ctx[2] && /*click_handler*/ ctx[8]))
                            /*onClick*/ (ctx[2] && /*click_handler*/ ctx[8]).apply(this, arguments);
                    }),
                    listen(div1, 'contextmenu', function () {
                        if (is_function(/*onContextMenu*/ ctx[3] && /*contextmenu_handler*/ ctx[9]))
                            /*onContextMenu*/ (ctx[3] && /*contextmenu_handler*/ ctx[9]).apply(this, arguments);
                    }),
                    listen(div1, 'pointerover', function () {
                        if (is_function(/*onHover*/ ctx[1] && /*pointerover_handler*/ ctx[10]))
                            /*onHover*/ (ctx[1] && /*pointerover_handler*/ ctx[10]).apply(this, arguments);
                    }),
                ];
        ...
        p(new_ctx, dirty) {
            ctx = new_ctx;
            if ((!current || dirty & /*date*/ 1) && t0_value !== (t0_value = /*date*/ ctx[0].format('D') + ''))
...
function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
        ...
        if ('incrementDisplayedMonth' in $$props)
            $$invalidate(2, (incrementDisplayedMonth = $$props.incrementDisplayedMonth));
        if ('decrementDisplayedMonth' in $$props)
            $$invalidate(3, (decrementDisplayedMonth = $$props.decrementDisplayedMonth));
    };
    ...
    return {
        c() {
            ...
            attr(
                ...
                'class',
                (div1_class_value =
                    '' + (null_to_empty(`week-num ${/*metadata*/ ctx[6].classes.join(' ')}`) + ' svelte-egt0yd')),
            );
                ...
                dispose = [
                    listen(div1, 'click', function () {
                        if (is_function(/*onClick*/ ctx[3] && /*click_handler*/ ctx[8]))
                            /*onClick*/ (ctx[3] && /*click_handler*/ ctx[8]).apply(this, arguments);
                    }),
                    listen(div1, 'contextmenu', function () {
                        if (is_function(/*onContextMenu*/ ctx[4] && /*contextmenu_handler*/ ctx[9]))
                            /*onContextMenu*/ (ctx[4] && /*contextmenu_handler*/ ctx[9]).apply(this, arguments);
                    }),
                    listen(div1, 'pointerover', function () {
                        if (is_function(/*onHover*/ ctx[2] && /*pointerover_handler*/ ctx[10]))
                            /*onHover*/ (ctx[2] && /*pointerover_handler*/ ctx[10]).apply(this, arguments);
                    }),
                ];
...
function create_each_block_2(ctx) {
    ...
    return {
        ...
        p(ctx, dirty) {
            if (dirty & /*daysOfWeek*/ 32768 && t_value !== (t_value = /*dayOfWeek*/ ctx[24] + ''))
                set_data(t, t_value);
        },
        d(detaching) {
            if (detaching) detach(th);
    ...
    return {
        ...
        p(new_ctx, dirty) {
            ...
            if (dirty & /*sources, month, today*/ 17664)
                day_changes.metadata = getDailyMetadata(/*sources*/ ctx[8], /*day*/ ctx[21], /*today*/ ctx[10]);
...
function create_fragment(ctx) {
    ...
    return {
        ...
        p(ctx, [dirty]) {
            ...
            if (dirty & /*onContextMenuWeek*/ 128)
                calendarbase_changes.onContextMenuWeek = /*onContextMenuWeek*/ ctx[7];
...
class CalendarView extends obsidian.ItemView {
    ...
    onHoverDay(date, targetEl, isMetaPressed) {
        ...
        this.app.workspace.trigger(
            ...
            targetEl,
            date.format(format),
            note === null || note === void 0 ? void 0 : note.path,
        );
    }
