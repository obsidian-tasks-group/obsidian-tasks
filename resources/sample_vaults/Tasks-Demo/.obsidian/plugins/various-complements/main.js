                    ...
                    if (i !== text2.length - 1) {
                        ...
                        for (let entries of [traditionalEntries, simplifiedEntries]) {
                            for (let entry of entries) {
                                ...
                                if (
                                    matchText === word2 &&
                                    (foundWord == null || Array.from(word2).length > Array.from(foundWord).length)
                                ) {
                                    foundWord = word2;
...
var groupBy = (values, toKey) =>
    values.reduce((prev, cur, _1, _2, k = toKey(cur)) => ((prev[k] || (prev[k] = [])).push(cur), prev), {});
...
function uniqWith(arr, fn) {
    return arr.filter((element2, index) => arr.findIndex((step) => fn(element2, step)) === index);
}
...
function removeFromPattern(pattern, removeChars) {
    return new RegExp(pattern.source.replace(new RegExp(`[${removeChars}]`, 'g'), ''), pattern.flags);
}
...
var AppHelper = class {
    ...
    getBoolFrontMatter(file, key) {
        var _a, _b;
        return Boolean(
            (_b = (_a = this.unsafeApp.metadataCache.getFileCache(file)) == null ? void 0 : _a.frontmatter) == null
                ? void 0
                : _b[key],
        );
    }
    ...
    optimizeMarkdownLinkText(linkText) {
        ...
        if (markdownLink.startsWith('[[')) {
            const text2 =
                (_a = markdownLink.matchAll(/^\[\[(?<text>.+)]]$/g).next().value.groups) == null ? void 0 : _a.text;
            return { displayed: text2, link: text2 };
        } else {
            const { displayed, link } = markdownLink.matchAll(/^\[(?<displayed>.+)]\(\<?(?<link>.+)\.md\>?\)$/g).next()
                .value.groups;
    ...
    linkText2Path(linkText) {
        ...
        return (_b =
            (_a = this.unsafeApp.metadataCache.getFirstLinkpathDest(linkText, activeFile.path)) == null
                ? void 0
                : _a.path) != null
            ? _b
            : null;
    ...
    inMathBlock(editor) {
        ...
        const numberOfDollarPair =
            (_b = (_a = this.getContentUntilCursor(editor).match(/\$\$\n/g)) == null ? void 0 : _a.length) != null
                ? _b
                : 0;
    ...
    searchPhantomLinks() {
        return Object.entries(this.unsafeApp.metadataCache.unresolvedLinks).flatMap(([path2, obj]) =>
            Object.keys(obj).map((link) => ({ path: path2, link })),
        );
    }
    getResolvedLinks(file) {
        var _a, _b;
        return (_b = Object.keys((_a = this.unsafeApp.metadataCache.resolvedLinks[file.path]) != null ? _a : {})) !=
            null
            ? _b
            : [];
    }
    ...
    getCurrentFrontMatter() {
        ...
        const keyLocations = Array.from(editor.getValue().matchAll(/\s*['"]?(?<key>.+?)['"]?:/g));
    ...
    isIMEOn() {
        ...
        return !!((_c = (_b = cm5or6 == null ? void 0 : cm5or6.display) == null ? void 0 : _b.input) == null
            ? void 0
            : _c.composing);
    }
    isMobile() {
...
_WordTypeMeta._dict = {};
_WordTypeMeta.FRONT_MATTER = new _WordTypeMeta('frontMatter', 100, 'frontMatter');
_WordTypeMeta.INTERNAL_LINK = new _WordTypeMeta('internalLink', 90, 'internalLink');
_WordTypeMeta.CUSTOM_DICTIONARY = new _WordTypeMeta('customDictionary', 80, 'suggestion');
_WordTypeMeta.CURRENT_FILE = new _WordTypeMeta('currentFile', 70, 'suggestion');
_WordTypeMeta.CURRENT_VAULT = new _WordTypeMeta('currentVault', 60, 'suggestion');
...
function judge(word, query, queryStartWithUpper, options) {
    ...
    if (
        ...
        (matched.type === 'fuzzy_match' &&
            matched.score > ((_a = options == null ? void 0 : options.fuzzy) == null ? void 0 : _a.minMatchScore))
    ) {
    ...
    const matchedAlias =
        (_b = word.aliases) == null
            ...
            : _b
                  ...
                  .sort((a, b) => (a.matched.type === 'concrete_match' && b.matched.type !== 'concrete_match' ? -1 : 0))
        ...
        (matchedAlias.matched.type === 'concrete_match' ||
            (matchedAlias.matched.type === 'fuzzy_match' &&
                matchedAlias.matched.score >
                    ((_c = options == null ? void 0 : options.fuzzy) == null ? void 0 : _c.minMatchScore)))
    ) {
        return {
            word: {
                ...word,
...
function suggestWords(indexedWords, query, maxNum, option = {}) {
    ...
    const words = queryStartWithUpper
        ? frontMatter
            ...
            : [
                  ...(shouldIncludeProvider('currentFile')
                      ...
                      : []),
                  ...(shouldIncludeProvider('currentFile')
                      ? (_b = indexedWords.currentFile[query.charAt(0).toLowerCase()]) != null
                          ? _b
                          : []
                      : []),
                  ...(shouldIncludeProvider('currentVault')
                      ...
                      : []),
                  ...(shouldIncludeProvider('currentVault')
                      ? (_d = indexedWords.currentVault[query.charAt(0).toLowerCase()]) != null
                          ? _d
                          : []
                      : []),
                  ...(shouldIncludeProvider('customDictionary')
                      ...
                      : []),
                  ...(shouldIncludeProvider('customDictionary')
                      ? (_f = indexedWords.customDictionary[query.charAt(0).toLowerCase()]) != null
                          ? _f
                          : []
                      : []),
                  ...(shouldIncludeProvider('internalLink')
                      ...
                      : []),
                  ...(shouldIncludeProvider('internalLink')
                      ? (_h = indexedWords.internalLink[query.charAt(0).toLowerCase()]) != null
                          ? _h
                          : []
                      : []),
              ]
        : frontMatter
          ...
          : [
                ...(shouldIncludeProvider('currentFile')
                    ? (_i = indexedWords.currentFile[query.charAt(0)]) != null
                        ? _i
                        : []
                    : []),
                ...(shouldIncludeProvider('currentFile')
                    ? (_j = indexedWords.currentFile[query.charAt(0).toUpperCase()]) != null
                        ? _j
                        : []
                    : []),
                ...(shouldIncludeProvider('currentVault')
                    ...
                    : []),
                ...(shouldIncludeProvider('currentVault')
                    ? (_l = indexedWords.currentVault[query.charAt(0).toUpperCase()]) != null
                        ? _l
                        : []
                    : []),
                ...(shouldIncludeProvider('customDictionary')
                    ...
                    : []),
                ...(shouldIncludeProvider('customDictionary')
                    ? (_n = indexedWords.customDictionary[query.charAt(0).toUpperCase()]) != null
                        ? _n
                        : []
                    : []),
                ...(shouldIncludeProvider('internalLink')
                    ...
                    : []),
                ...(shouldIncludeProvider('internalLink')
                    ? (_p = indexedWords.internalLink[query.charAt(0).toUpperCase()]) != null
                        ? _p
                        : []
                    : []),
            ];
    ...
    const latestUpdated = max(
        filteredJudgement.map((x) => {
            ...
            return (_b2 =
                (_a2 =
                    selectionHistoryStorage == null ? void 0 : selectionHistoryStorage.getSelectionHistory(x.word)) ==
                null
                    ? void 0
    ...
    if (
        ...
        (startsWithMatched.type === 'fuzzy_match' &&
            startsWithMatched.score >
                ((_a = options == null ? void 0 : options.fuzzy) == null ? void 0 : _a.minMatchScore))
    ) {
        if (queryStartWithUpper && word.type !== 'internalLink' && word.type !== 'frontMatter') {
            const c = capitalizeFirstLetter(word.value);
            return {
        ...
        (includesMatched.type === 'concrete_match' ||
            (includesMatched.type === 'fuzzy_match' &&
                includesMatched.score >
                    ((_d = options == null ? void 0 : options.fuzzy) == null ? void 0 : _d.minMatchScore)))
    ) {
        return {
            word: {
                ...word,
        ...
        (matchedAliasIncluded.matched.type === 'concrete_match' ||
            (matchedAliasIncluded.matched.type === 'fuzzy_match' &&
                matchedAliasIncluded.matched.score >
                    ((_f = options == null ? void 0 : options.fuzzy) == null ? void 0 : _f.minMatchScore)))
    ) {
        return {
            word: {
                ...word,
...
function suggestWordsByPartialMatch(indexedWords, query, maxNum, option = {}) {
    ...
    const latestUpdated = max(
        filteredJudgement.map((x) => {
            var _a, _b;
            return (_b =
                (_a = selectionHistoryStorage == null ? void 0 : selectionHistoryStorage.getSelectionHistory(x.word)) ==
                null
                    ? void 0
                    : _a.lastUpdated) != null
                ? _b
...
_MatchStrategy.PARTIAL = new _MatchStrategy('partial', suggestWordsByPartialMatch);
...
_SpecificMatchStrategy.INHERIT = new _SpecificMatchStrategy('inherit', neverUsedHandler);
_SpecificMatchStrategy.PREFIX = new _SpecificMatchStrategy('prefix', suggestWords);
_SpecificMatchStrategy.PARTIAL = new _SpecificMatchStrategy('partial', suggestWordsByPartialMatch);
...
_TokenizeStrategy.ENGLISH_ONLY = new _TokenizeStrategy('english-only', 3, 5, true);
...
var VariousComplementsSettingTab = class extends import_obsidian3.PluginSettingTab {
    ...
    async addMainSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Strategy').addDropdown((tc) =>
            tc
        ...
        if (this.plugin.settings.strategy === TokenizeStrategy.CHINESE.name) {
            ...
            const hasCedict = await app.vault.adapter.exists(this.plugin.settings.cedictPath);
            if (!hasCedict) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Match strategy').addDropdown((tc) =>
            tc
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .setDesc('It only shows suggestions whose fuzzy matched score is more than the specific value.')
            .addSlider((sc) =>
                sc
                    .setLimits(0, 5, 0.1)
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .setDesc("Ex: If enabled, 'aaa' matches with '\xE1\xE4\u0101'")
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.treatAccentDiacriticsAsAlphabeticCharacters).onChange(
                    async (value) => {
        ...
        if (TokenizeStrategy.fromName(this.plugin.settings.strategy).canTreatUnderscoreAsPartOfWord) {
            new import_obsidian3.Setting(containerEl)
                ...
                .addToggle((tc) => {
                    tc.setValue(this.plugin.settings.treatUnderscoreAsPartOfWord).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .setDesc("Ex: If enabled, 'aaa' matches with '\u{1F600}aaa'")
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.matchingWithoutEmoji).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl).setName('Max number of suggestions').addSlider((sc) =>
            sc
                .setLimits(1, 255, 1)
        ...
        new import_obsidian3.Setting(containerEl).setName('Min number of words for trigger').addSlider((sc) =>
            sc
                .setLimits(1, 10, 1)
        ...
        new import_obsidian3.Setting(containerEl).setName('Complement automatically').addToggle((tc) => {
            tc.setValue(this.plugin.settings.complementAutomatically).onChange(async (value) => {
                this.plugin.settings.complementAutomatically = value;
                await this.plugin.saveSettings();
            });
        });
        new import_obsidian3.Setting(containerEl).setName('Delay milli-seconds for trigger').addSlider((sc) =>
            sc
                .setLimits(0, 1e3, 10)
        ...
        new import_obsidian3.Setting(containerEl).setName('Disable suggestions during IME on').addToggle((tc) => {
            tc.setValue(this.plugin.settings.disableSuggestionsDuringImeOn).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .setDesc('Disables suggestions within math blocks. This setting does not apply to inline blocks.')
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.disableSuggestionsInMathBlock).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .setDesc('Disables suggestions within code blocks. This setting does not apply to inline blocks.')
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.disableSuggestionsInCodeBlock).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl).setName('Insert space after completion').addToggle((tc) => {
            tc.setValue(this.plugin.settings.insertSpaceAfterCompletion).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl).setName('First characters to disable suggestions').addText((cb) => {
            cb.setValue(this.plugin.settings.firstCharactersDisableSuggestions).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addTextArea((tc) => {
                const el = tc
                    .setValue(this.plugin.settings.phrasePatternsToSuppressTrigger.join('\n'))
                    .onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.noAutoFocusUntilCycle).onChange(async (value) => {
    ...
    addAppearanceSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.showMatchStrategy).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.showComplementAutomatically).onChange(async (value) => {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.showIndexingStatus).onChange(async (value) => {
                    this.plugin.settings.showIndexingStatus = value;
                    await this.plugin.saveSettings();
                });
            });
        new import_obsidian3.Setting(containerEl).setName('Description on a suggestion').addDropdown((tc) =>
            tc
    ...
    addKeyCustomizationSettings(containerEl) {
        ...
        Object.keys(hotkeys).forEach((k) => {
            const key = k;
            new import_obsidian3.Setting(div)
                .setName(key)
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.propagateEsc).onChange(async (value) => {
    ...
    addCurrentFileComplementSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Enable Current file complement').addToggle((tc) => {
            tc.setValue(this.plugin.settings.enableCurrentFileComplement).onChange(async (value) => {
        ...
        if (this.plugin.settings.enableCurrentFileComplement) {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addToggle((tc) => {
                    tc.setValue(this.plugin.settings.onlyComplementEnglishOnCurrentFileComplement).onChange(
                        async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .setDesc('Regexp patterns for words to be excluded from the suggestions, separated by line breaks.')
                .addTextArea((tc) => {
                    const el = tc
                        .setValue(this.plugin.settings.excludeCurrentFileWordPatterns.join('\n'))
                        .onChange(async (value) => {
    ...
    addCurrentVaultComplementSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Enable Current vault complement').addToggle((tc) => {
            tc.setValue(this.plugin.settings.enableCurrentVaultComplement).onChange(async (value) => {
        ...
        if (this.plugin.settings.enableCurrentVaultComplement) {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addToggle((tc) => {
                    tc.setValue(this.plugin.settings.includeCurrentVaultOnlyFilesUnderCurrentDirectory).onChange(
                        async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addTextArea((tc) => {
                    const el = tc
                        .setValue(this.plugin.settings.excludeCurrentVaultWordPatterns.join('\n'))
                        .onChange(async (value) => {
    ...
    addCustomDictionaryComplementSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Enable Custom dictionary complement').addToggle((tc) => {
            tc.setValue(this.plugin.settings.enableCustomDictionaryComplement).onChange(async (value) => {
        ...
        if (this.plugin.settings.enableCustomDictionaryComplement) {
            ...
            new import_obsidian3.Setting(containerEl).setName('Column delimiter').addDropdown((tc) =>
                tc
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    cb.setValue(this.plugin.settings.customDictionaryWordRegexPattern).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    cb.setValue(this.plugin.settings.delimiterToHideSuggestion).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    cb.setValue(this.plugin.settings.delimiterToDivideSuggestionsForDisplayFromInsertion).onChange(
                        async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    cb.setValue(this.plugin.settings.caretLocationSymbolAfterComplement).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    cb.setValue(this.plugin.settings.displayedTextSuffix).onChange(async (value) => {
    ...
    addInternalLinkComplementSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Enable Internal link complement').addToggle((tc) => {
            tc.setValue(this.plugin.settings.enableInternalLinkComplement).onChange(async (value) => {
        ...
        if (this.plugin.settings.enableInternalLinkComplement) {
            new import_obsidian3.Setting(containerEl).setName('Suggest with an alias').addToggle((tc) => {
                tc.setValue(this.plugin.settings.suggestInternalLinkWithAlias).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl).setName('Update internal links on save').addToggle((tc) => {
                tc.setValue(this.plugin.settings.updateInternalLinksOnSave).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl).setName('Exclude self internal link').addToggle((tc) => {
                tc.setValue(this.plugin.settings.excludeSelfInternalLink).onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addToggle((tc) => {
                    tc.setValue(this.plugin.settings.excludeExistingInActiveFileInternalLinks).onChange(
                        async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                .setName('Insert an alias that is transformed from the displayed internal link')
                .addToggle((tc) => {
                    tc.setValue(this.plugin.settings.insertAliasTransformedFromDisplayedInternalLink.enabled).onChange(
                        async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addTextArea((tac) => {
                    const el = tac
                        .setValue(this.plugin.settings.excludeInternalLinkPathGlobPatterns.join('\n'))
                        .setPlaceholder('**/attachments\n**/*.png')
                        .onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    TextComponentEvent.onChange(cb, async (value) => {
                        ...
                        await this.plugin.saveSettings({ internalLink: true });
                    }).setValue(this.plugin.settings.frontMatterKeyForExclusionInternalLink);
                });
            new import_obsidian3.Setting(containerEl)
                ...
                .addTextArea((tc) => {
                    const el = tc
                        .setValue(this.plugin.settings.tagsForExclusionInternalLink.join('\n'))
                        .onChange(async (value) => {
    ...
    addFrontMatterComplementSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Enable Front matter complement').addToggle((tc) => {
            tc.setValue(this.plugin.settings.enableFrontMatterComplement).onChange(async (value) => {
        ...
        if (this.plugin.settings.enableFrontMatterComplement) {
            new import_obsidian3.Setting(containerEl).setName('Match strategy in the front matter').addDropdown((tc) =>
                tc
            ...
            new import_obsidian3.Setting(containerEl).setName('Insert comma after completion').addToggle((tc) => {
                tc.setValue(this.plugin.settings.insertCommaAfterFrontMatterCompletion).onChange(async (value) => {
    ...
    addIntelligentSuggestionPrioritizationSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl)
            ...
            .addToggle((tc) => {
                tc.setValue(this.plugin.settings.intelligentSuggestionPrioritization.enabled).onChange(
                    async (value) => {
        ...
        if (this.plugin.settings.intelligentSuggestionPrioritization.enabled) {
            new import_obsidian3.Setting(containerEl)
                ...
                .addText((cb) => {
                    ...
                    }).setValue(this.plugin.settings.intelligentSuggestionPrioritization.historyFilePath);
                });
            new import_obsidian3.Setting(containerEl)
                ...
                .addSlider((sc) =>
                    sc
                        .setLimits(0, 365, 1)
                        .setValue(this.plugin.settings.intelligentSuggestionPrioritization.maxDaysToKeepHistory)
                        .setDynamicTooltip()
                        .onChange(async (value) => {
            ...
            new import_obsidian3.Setting(containerEl)
                ...
                .addSlider((sc) =>
                    sc
                        .setLimits(0, 1e4, 1)
                        .setValue(this.plugin.settings.intelligentSuggestionPrioritization.maxNumberOfHistoryToKeep)
                        .setDynamicTooltip()
                        .onChange(async (value) => {
    ...
    addMobileSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Disable on mobile').addToggle((tc) => {
            tc.setValue(this.plugin.settings.disableOnMobile).onChange(async (value) => {
    ...
    addDebugSettings(containerEl) {
        ...
        new import_obsidian3.Setting(containerEl).setName('Show log about performance in a console').addToggle((tc) => {
            tc.setValue(this.plugin.settings.showLogAboutPerformanceInConsole).onChange(async (value) => {
...
var CurrentFileWordProvider = class {
    ...
    async refreshWords(option) {
        ...
        const currentToken = this.tokenizer
            ...
            .last();
        const excludePatterns = option.excludeWordPatterns.map((x) => new RegExp(`^${x}$`));
        ...
        for (const word of this.words) {
            ...
            (_a = word.aliases) == null
                ? void 0
                : _a.forEach((a) => pushWord(this.wordsByFirstLetter, a.charAt(0), word));
        }
    }
    clearWords() {
        this.words = [];
...
var _AST = class _AST {
    constructor(type, parent, options = {}) {
        ...
        __privateSet(
            this,
            _options,
            __privateGet(this, _root) === this ? options : __privateGet(__privateGet(this, _root), _options),
        );
        __privateSet(
            this,
            _negs,
            __privateGet(this, _root) === this ? [] : __privateGet(__privateGet(this, _root), _negs),
        );
        if (type === '!' && !__privateGet(__privateGet(this, _root), _filledNegs)) __privateGet(this, _negs).push(this);
        __privateSet(
            this,
            _parentIndex,
            __privateGet(this, _parent) ? __privateGet(__privateGet(this, _parent), _parts).length : 0,
        );
    }
    get hasMagic() {
            ...
            if (this.isStart()) {
                if (typeof __privateGet(this, _parts)[0] === 'string') {
                    const dotTravAllowed =
                        __privateGet(this, _parts).length === 1 && justDots.has(__privateGet(this, _parts)[0]);
                    if (!dotTravAllowed) {
...
var Minimatch = class {
    constructor(pattern, options = {}) {
        ...
        this.windowsNoMagicRoot =
            options.windowsNoMagicRoot !== void 0 ? options.windowsNoMagicRoot : !!(this.isWindows && this.nocase);
        this.globSet = [];
        this.globParts = [];
        this.set = [];
        this.make();
    ...
    make() {
        ...
        let set = this.globParts.map((s, _, __) => {
            if (this.isWindows && this.windowsNoMagicRoot) {
                const isUNC =
                    s[0] === '' && s[1] === '' && (s[2] === '?' || !globMagic.test(s[2])) && !globMagic.test(s[3]);
    ...
    matchOne(file, pattern, partial = false) {
        ...
        if (this.isWindows) {
            ...
            const fileUNC =
                !fileDrive && file[0] === '' && file[1] === '' && file[2] === '?' && /^[a-z]:$/i.test(file[3]);
...
var CurrentVaultWordProvider = class {
    ...
    async refreshWords(option) {
        ...
        for (const path2 of markdownFilePaths) {
            ...
            const tokens = this.tokenizer
                .tokenize(content)
                .filter((x) => x.length >= option.minNumberOfCharacters && !this.tokenizer.shouldIgnoreOnCurrent(x))
                .map((x) => (startsSmallLetterOnlyFirst(x) ? x.toLowerCase() : x))
                .filter((x) => !excludePatterns.some((rp) => x.match(rp)));
            for (const token of tokens) {
                wordByValue[token] = {
...
function wordToLine(word, delimiter, dividerForDisplay) {
    const value =
        word.insertedText && dividerForDisplay ? `${word.value}${dividerForDisplay}${word.insertedText}` : word.value;
...
var CustomDictionaryWordProvider = class {
    ...
    async loadWords(path2, option) {
        const contents = isURL(path2)
            ? await (0, import_obsidian4.request)({ url: path2 })
            : await this.fileSystemAdapter.read(path2);
        const words = path2.endsWith('.json')
            ? jsonToWords(JSON.parse(contents), path2, option.caretSymbol)
            : contents
                  .split(/\r\n|\n/)
                  .map((x) => x.replace(/%%.*%%/g, ''))
                  .filter((x) => x)
 ...
 ${e}`,
    ...
    addWord(word, synonymOption) {
        ...
        const wordWithSynonym = {
            ...word,
            aliases: [...((_a = word.aliases) != null ? _a : []), ...synonymAliases(word.value, synonymOption)],
        };
        ...
        (_b = wordWithSynonym.aliases) == null
            ? void 0
            : _b.forEach((a) => pushWord(this.wordsByFirstLetter, a.charAt(0), wordWithSynonym));
    }
    clearWords() {
        this.words = [];
        this.wordByValue = {};
...
function pickWords(file, fm) {
    return Object.entries(fm)
        .filter(([_key, value]) => value != null && (typeof value === 'string' || typeof value[0] === 'string'))
...
function indexingWords(words) {
    ...
    return Object.fromEntries(
        Object.entries(wordsByKey).map(([key, words2]) => [key, groupBy(words2, (w) => w.value.charAt(0))]),
    );
}
            ...
            for (const value of Object.keys(this.data[hit])) {
                for (const kind of Object.keys(this.data[hit][value])) {
                    if (
                        ...
                        now2 - this.data[hit][value][kind].lastUpdated > this.maxDaysToKeepHistory * DAY
                    ) {
...
var AbstractTokenizer = class {
    constructor(args) {
        this.inputTrimCharPattern = (args == null ? void 0 : args.treatUnderscoreAsPartOfWord)
            ? removeFromPattern(INPUT_TRIM_CHAR_PATTERN, '_')
            : INPUT_TRIM_CHAR_PATTERN;
        this.indexingTrimCharPattern = (args == null ? void 0 : args.treatUnderscoreAsPartOfWord)
...
var EnglishOnlyTokenizer = class extends DefaultTokenizer {
    tokenize(content, raw) {
        const tokenized = Array.from(this._tokenize(content, 'indexing')).filter((x) => x.word.match(ENGLISH_PATTERN));
        return raw
            ? tokenized.map((x) => x.word)
            : tokenized.map((x) => x.word).filter((x) => !x.match(this.getTrimPattern('indexing')));
    }
    recursiveTokenize(content) {
...
var JapaneseTokenizer = class extends AbstractTokenizer {
    tokenize(content, raw) {
        return pickTokensAsJapanese(content, raw ? / /g : this.getTrimPattern('indexing'));
    }
    recursiveTokenize(content) {
        const tokens = joinNumberWithSymbol(
            segmenter.segment(content).flatMap((x) => (x === ' ' ? x : x.split(' ').map((t) => (t === '' ? ' ' : t)))),
        );
        const ret = [];
        for (let i = 0; i < tokens.length; i++) {
...
var HALFWIDTH_FULLWIDTH_FORMS_KO =
    '\uFFA0-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC\uFFE0-\uFFE6\uFFE8-\uFFEE';
...
var KoreanTokenizer = class extends DefaultTokenizer {
    constructor(args) {
        super();
        this.inputTrimCharPattern = (args == null ? void 0 : args.treatUnderscoreAsPartOfWord)
            ? removeFromPattern(INPUT_TRIM_CHAR_PATTERN2, '_')
            : INPUT_TRIM_CHAR_PATTERN2;
        this.indexingTrimCharPattern = (args == null ? void 0 : args.treatUnderscoreAsPartOfWord)
            ? removeFromPattern(INDEXING_TRIM_CHAR_PATTERN2, '_')
            : INDEXING_TRIM_CHAR_PATTERN2;
    }
    tokenize(content, raw) {
        ...
        return raw
            ? tokenized.map((x) => x.word)
            : tokenized.map((x) => x.word).filter((x) => !this.indexingTrimCharPattern.test(x));
    }
    recursiveTokenize(content) {
        const offsets = Array.from(this._tokenize(content, 'input'))
...
async function createTokenizer(strategy, app2, settings) {
    switch (strategy.name) {
        ...
        case 'chinese':
            ...
            if (!hasCedict) {
                return Promise.reject(new Error(`cedict_ts.u8 doesn't exist in ${settings.cedictPath}.`));
            }
...
var AutoCompleteSuggest = class _AutoCompleteSuggest extends import_obsidian7.EditorSuggest {
    ...
    static async new(app2, settings, statusBar, onPersistSelectionHistory) {
        ...
        ins.activeLeafChangeRef = app2.workspace.on('active-leaf-change', async (_) => {
            await ins.refreshCurrentFileTokens();
    ...
    async updateSettings(settings) {
        ...
        this.debounceGetSuggestions = (0, import_obsidian7.debounce)(
            (context, cb) => {
                ...
                const matchStrategy = MatchStrategy.fromName(parsedQuery.completionMode);
                let words = parsedQuery.queries
                    .filter(
                        (x, i, xs) =>
                            parsedQuery.currentFrontMatter ||
                            (this.settings.minNumberOfWordsTriggeredPhrase + i - 1 < xs.length &&
                    ...
                    .map((q) => {
                        const handler =
                            parsedQuery.currentFrontMatter &&
                            this.frontMatterComplementStrategy !== SpecificMatchStrategy.INHERIT
                        ...
                        return handler(this.indexedWords, q.word, this.settings.maxNumberOfSuggestions, {
                            ...
                            globalMinChar:
                                this.settings.minNumberOfCharactersTriggered || this.tokenizerStrategy.triggerThreshold,
                ...
                if (this.settings.excludeSelfInternalLink) {
                    words = words.filter((x) => {
                        ...
                        return (
                            x.type !== 'internalLink' ||
                            x.createdPath !== ((_a = this.appHelper.getActiveFile()) == null ? void 0 : _a.path)
                        );
                    });
                }
                if (this.settings.excludeExistingInActiveFileInternalLinks) {
                    ...
                    words = words.filter((x) => x.type !== 'internalLink' || !linkPaths.includes(x.createdPath));
                }
    ...
    setHotKey(name, handler) {
        this.settings.hotkeys[name].forEach((hk) => {
            this.keymapEventHandler.push(this.scope.register(hk.modifiers, hk.key, handler));
        });
    }
    setHotKeys(...params) {
    ...
    async refreshCurrentFileTokens() {
        ...
        if (!this.settings.enableCurrentFileComplement) {
            ...
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462} Skip: Index current file tokens', performance.now() - start),
            );
            return;
        }
    ...
    async refreshCurrentVaultTokens() {
        ...
        if (!this.settings.enableCurrentVaultComplement) {
            ...
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462} Skip: Index current vault tokens', performance.now() - start),
            );
            return;
        }
    ...
    async refreshCustomDictionaryTokens() {
        ...
        if (!this.settings.enableCustomDictionaryComplement) {
            ...
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462}Skip: Index custom dictionary tokens', performance.now() - start),
            );
            return;
        }
    ...
    refreshInternalLinkTokens() {
        ...
        if (!this.settings.enableInternalLinkComplement) {
            ...
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462}Skip: Index internal link tokens', performance.now() - start),
            );
            return;
        }
    ...
    refreshFrontMatterTokens() {
        ...
        if (!this.settings.enableFrontMatterComplement) {
            ...
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462}Skip: Index front matter tokens', performance.now() - start),
            );
            return;
        }
    ...
    updateFrontMatterTokenIndex(file) {
        ...
        if (!this.settings.enableFrontMatterComplement) {
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462}Skip: Update front matter token index', performance.now() - start),
            );
            return;
        }
    ...
    updateFrontMatterToken() {
        ...
        if (!this.settings.enableFrontMatterComplement) {
            this.showDebugLog(() =>
                buildLogMessage('\u{1F462}Skip: Update front matter token', performance.now() - start),
            );
            return;
        }
    ...
    onTrigger(cursor, editor) {
        ...
        const suppressedPattern = this.settings.patternsToSuppressTrigger.find((p) =>
            new RegExp(p).test(currentLineUntilCursor),
        );
        if (suppressedPattern) {
            onReturnNull(`Don't show suggestions because it is the ignored pattern: ${suppressedPattern}`);
            return null;
        }
        if (this.settings.disableSuggestionsInMathBlock && this.appHelper.inMathBlock(editor)) {
            onReturnNull(`Suggestions are disabled while the cursor is inside a Math block.`);
            return null;
        }
        if (this.settings.disableSuggestionsInCodeBlock && this.appHelper.inCodeBlock(editor)) {
            onReturnNull(`Suggestions are disabled while the cursor is inside a Code block.`);
            return null;
        }
        ...
        if (currentTokenSeparatedWhiteSpace === this.pastCurrentTokenSeparatedWhiteSpace && !this.runManually) {
            onReturnNull(`Don't show suggestions because currentTokenSeparatedWhiteSpace doesn't change`);
            return null;
        }
        ...
        if (currentPhrase.length === 1 && Boolean(currentPhrase.match(this.tokenizer.getTrimPattern('input')))) {
            onReturnNull(`Don't show suggestions because currentPhrase is TRIM_PATTERN`);
            return null;
        }
        if (!this.runManually && !currentFrontMatter && currentPhrase.length < this.minNumberTriggered) {
            onReturnNull("Don't show suggestions because currentPhrase is less than minNumberTriggered option");
            return null;
        }
        if (this.runManually) {
        ...
        const suppressedTokens =
            patterns.length === 0 || currentFrontMatter
                ? currentTokens
                : currentTokens.filter((t) => patterns.every((p) => !new RegExp(`^${p}$`).test(t.word)));
        if (suppressedTokens.length === 0) {
            onReturnNull("Don't show suggestions because all tokens are ignored by token pattern");
            return null;
        }
        ...
        return {
            start: {
                ch:
                    cursor.ch -
                    ((_e =
                        (_d = (_c = currentTokens.last()) == null ? void 0 : _c.word) == null ? void 0 : _d.length) !=
                    null
                        ? _e
                        : 0),
    ...
    constructInternalLinkText(word, forceWithAlias) {
        if ((this.settings.suggestInternalLinkWithAlias || forceWithAlias) && word.aliasMeta) {
            const { link: link2 } = this.appHelper.optimizeMarkdownLinkText(word.aliasMeta.origin);
            return this.appHelper.useWikiLinks
                ? `[[${link2}|${word.value}]]`
                : `[${word.value}](${encodeSpace(link2)}.md)`;
        }
        const pattern = this.settings.insertAliasTransformedFromDisplayedInternalLink.enabled
            ? new RegExp(this.settings.insertAliasTransformedFromDisplayedInternalLink.beforeRegExp)
            : null;
        const match2 = (value) => (pattern ? Boolean(value.match(pattern)) : false);
        const replaceByPattern = (value) =>
            pattern
                ? value.replace(pattern, this.settings.insertAliasTransformedFromDisplayedInternalLink.after)
                : value;
    ...
    selectSuggestion(word) {
        ...
        if (positionToMove !== -1) {
            editor.setCursor(
                editor.offsetToPos(editor.posToOffset(editor.getCursor()) - insertedText.length + positionToMove),
            );
        }
...
function ensure_array_like(array_like_or_iterator) {
    return (array_like_or_iterator == null ? void 0 : array_like_or_iterator.length) !== void 0
...
function create_each_block(ctx) {
    ...
    return {
        ...
        p(ctx2, dirty) {
            if (dirty /*dictionaries*/ & 32 && t0_value !== (t0_value = /*dictionary*/ ctx2[26].path + ''))
                set_data(t0, t0_value);
            if (dirty /*dictionaries*/ & 32 && option_value_value !== (option_value_value = /*dictionary*/ ctx2[26])) {
...
function create_fragment4(ctx) {
    ...
    return {
        ...
        p(ctx2, [dirty]) {
            ...
            if (dirty /*description*/ & 16 && input.value /*description*/ !== ctx2[4]) {
                set_input_value(
                    input,
                    /*description*/
                    ctx2[4],
            ...
            if (dirty /*enableSubmit*/ & 4096) obsidianbutton_changes.disabled = !(/*enableSubmit*/ ctx2[12]);
            if (dirty /*$$scope*/ & 536870912) {
...
function instance4($$self, $$props, $$invalidate) {
    ...
    onMount(() => {
        setTimeout(() => (wordRef === null || wordRef === void 0 ? void 0 : wordRef.focus()), 50);
    });
...
var VariousComponents = class extends import_obsidian9.Plugin {
    ...
    async onload() {
        ...
        this.suggester = await AutoCompleteSuggest.new(this.app, this.settings, this.statusBar, debouncedSaveData);
        ...
        this.addCommand({
            ...
            callback: async () => {
                await navigator.clipboard.writeText(this.settingTab.getPluginSettingsAsJsonString());
