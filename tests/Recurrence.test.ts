...
describe('Recurrence', () => {
    ...
    it('creates a recurrence 3 months in', () => {
        ...
        expect(next!.startDate).toBeNull();
        expect(next!.scheduledDate).toBeNull();
        expect(next!.dueDate).toBeSameMoment(moment('2022-04-30'));
    });
    ...
    it('creates a recurrence the next month, even across years', () => {
        ...
        expect(next!.startDate).toBeNull();
        expect(next!.scheduledDate).toBeNull();
        expect(next!.dueDate).toBeSameMoment(moment('2024-02-29'));
    });
    ...
    it('creates a recurrence in 2 years, even on Feb 29th', () => {
        ...
        expect(next!.startDate).toBeNull();
        expect(next!.scheduledDate).toBeNull();
        expect(next!.dueDate).toBeSameMoment(moment('2026-02-28'));
    });
    ...
    it('creates a recurrence in 11 months, even on March 31', () => {
        ...
        expect(next!.startDate).toBeNull();
        expect(next!.scheduledDate).toBeNull();
        expect(next!.dueDate).toBeSameMoment(moment('2021-02-28'));
    });
...
describe('Recurrence - with invalid dates in tasks', () => {
    ...
    it('creates a recurrence if a lower priority date is invalid', () => {
        ...
        expect(next!.scheduledDate).toBeSameMoment(moment('2022-02-28')); // date was invalid, so is given the value of highest priority supplied date
        expect(next!.dueDate).toBeSameMoment(moment('2022-02-28'));
    });
});
