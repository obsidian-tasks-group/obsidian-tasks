...
describe('task line rendering - debug info rendering', () => {
    it('renders debug info if requested', async () => {
        ...
        expect(renderedDescription).toEqual(
            'Task with debug info<br><span class="tasks-debug">🐛 <b>0</b> . 0 . 0</span><br><code class="tasks-debug">\'- [ ] Task with debug info\'</code><br><code class="tasks-debug">\'a/b/c.d\' > \'Previous Heading\'</code><br>',
        );
    });
});
