    ...
    it('should apply edit all fields in a fully populated task', async () => {
        ...
        expect(appliedEdits[0]).toMatchInlineSnapshot(`
            Task {
              ...
              "listMarker": "-",
              "onCompletion": "",
              "originalMarkdown": "  - [ ] Do exercises #todo #health 🆔 abcdef ⛔ 123456,abc123 🔼 🔁 every day when done 🏁 delete ➕ 2023-07-01 🛫 2023-07-02 ⏳ 2023-07-03 ⏱ 26h59m 📅 2023-07-04 ❌ 2023-07-06 ✅ 2023-07-05 ^dcf64c",
              "parent": null,
              "priority": "3",
              "recurrence": null,
              "scheduledDate": null,
