...
describe('postpone - name context menu option', () => {
    it('rename me', () => {
        ...
        expect(postponeMenuItemTitle(task, 1, 'day')).toEqual('Postpone dueDate for a day');
        expect(postponeMenuItemTitle(task, 2, 'days')).toEqual('Postpone dueDate for 2 days');
    });
});
