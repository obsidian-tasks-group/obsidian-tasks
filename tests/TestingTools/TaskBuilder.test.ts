...
describe('TaskBuilder', () => {
    ...
    it('createFullyPopulatedTask() should populate every field', () => {
        ...
        expect(task.originalMarkdown).toEqual(
            '  - [ ] Do exercises #todo #health 🆔 abcdef ⛔ 123456,abc123 🔼 🔁 every day when done 🏁 delete ➕ 2023-07-01 🛫 2023-07-02 ⏳ 2023-07-03 📅 2023-07-04 ⏰ 2023-07-04 09:00 ❌ 2023-07-06 ✅ 2023-07-05 ^dcf64c',
        );
    });
});
