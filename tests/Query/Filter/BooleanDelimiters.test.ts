...
function shouldThrow(line: string) {
    ...
    expect(t).toThrowError(
        'All filters in a Boolean instruction must be inside one of these pairs of delimiter characters: (...), [...], {...}, "...". Combinations of those delimiters are no longer supported.',
    );
}
