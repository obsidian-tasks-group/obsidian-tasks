...
describe('explain start date queries', () => {
    it('should explain explicit date', () => {
        ...
        expect(filterOrMessage).toHaveExplanation('start date is before 2023-01-02 (Monday) OR no start date');
    });
    ...
    it('implicit "on" gets added to explanation', () => {
        ...
        expect(filterOrMessage).toHaveExplanation('start date is 2023-01-02 (Monday) OR no start date');
    });
});
