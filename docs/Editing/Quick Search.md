...
- The task description is searched.
  - Fuzzy matching is case-insensitive, allows non-contiguous matches, and shows the closest matches first.
  - With fuzzy matching off, the search is case-insensitive and looks for the complete text you type.
...
- Fuzzy results with the same match score, and all results with fuzzy matching off, are sorted by description, ignoring Markdown formatting.
