...
_Release notes: [Tasks 7.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/7.0.0)._
...
_Release notes: [Tasks 6.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/6.0.0)._
...
_Release notes: [Tasks 5.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/5.0.0)._
...
_Release notes: [Tasks 4.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/4.0.0)._

- The order of `group by urgency` [[Grouping#Urgency|was reversed]].

## Tasks 3.0.0 (2 April 2023)

_Release notes: [Tasks 3.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/3.0.0)._
...
_Release notes: [Tasks 2.0.0](https://github.com/obsidian-tasks-group/obsidian-tasks/releases/tag/2.0.0)._
