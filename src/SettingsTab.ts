...
export class SettingsTab extends PluginSettingTab {
    ...
    public display(): void {
        ...
        containerEl.createEl('div', {
            cls: 'setting-item-description',
            text:
                'Previous versions did not have a concept of strict and/or lenient recurrence for tasks and instead only supported strict recurrence.\n' +
                'Disabling this setting will change the behavior of all existing recurring tasks to be lenient, which is the opposite of the previous default behavior.\n' +
                'Consider updating your vault before making changes to this setting.\n' +
                'If disabled, "🔁 every 10 days" will translate to lenient recurrence and will be scheduled 10 days after the "done" date rather than the "due" date.\n' +
