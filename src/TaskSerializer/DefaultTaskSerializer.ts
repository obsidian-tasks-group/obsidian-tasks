    ...
    public deserialize(line: string): TaskDetails {
        ...
        do {
            ...
            if (durationMatch !== null) {
                ...
                //note: as TaskFormatRegularExpressions.durationRegex is derived from Duration.valueRegEx
                //Duration.fromText() should never(!) return null.
                duration = Duration.fromText(durationMatch[1].trim())!;
                matched = true;
            }
