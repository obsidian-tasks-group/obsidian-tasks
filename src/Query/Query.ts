...
export class Query implements IQuery {
    ...
    private readonly hideOptionsRegexp =
        /^(hide|show) (task count|backlink|priority|created date|start date|scheduled date|done date|due date|recurrence rule|edit button|urgency|reminder date|reminders)/; // TODO Remove reminders
        ...
        if (hideOptionsMatch !== null) {
            ...
            switch (option) {
                ...
                case 'due date':
                    ...
                    break;
                case 'reminder date':
                case 'reminders': // TODO Remove reminders
