...
import type { NewFilter } from './Filter/Filter';
...
export class Query implements IQuery {
    ...
    private parseFilter(line: string) {
        ...
        if (filterOrError != null) {
            if (filterOrError.newFilter) this._filters.push(filterOrError.newFilter);
