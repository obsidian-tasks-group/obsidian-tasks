...
var Vi = (n) => Rn(n, '__esModule', { value: !0 });
var ka = (n, e) => {
        Vi(n);
        for (var t in e) Rn(n, t, { get: e[t], enumerable: !0 });
    },
    Sa = (n, e, t) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
            for (let r of ba(e))
                !Ta.call(n, r) &&
                    r !== 'default' &&
                    Rn(n, r, { get: () => e[r], enumerable: !(t = wa(e, r)) || t.enumerable });
        return n;
    },
    X = (n) =>
        Sa(
...
var re = (function () {
    ...
    return (
        ...
        (n.explainIfInvalidLinkUrl = function (e) {
            ...
            if (!n._urlSchemeAfterRegExp.test(e)) return 'An @link URL must have at least one character after "://"';
        }),
        ...
        (n.explainIfInvalidUnquotedIdentifier = function (e) {
            ...
            if (n._identifierNumberStartRegExp.test(e)) return 'The identifier must not start with a number';
        }),
        (n.explainIfInvalidUnquotedMemberIdentifier = function (e) {
            ...
            if (n.isSystemSelector(e))
                return 'The identifier "'.concat(e, '" must be quoted because it is a TSDoc system selector name');
        }),
...
var Pr = (function () {
    function n() {
        ((this._docNodeDefinitionsByKind = new Map()), (this._docNodeDefinitionsByConstructor = new Map()));
    }
    return (
        (n.prototype.registerDocNodes = function (e, t) {
            ...
            for (var i = 0, o = t; i < o.length; i++) {
                ...
                if (!n._nodeKindRegExp.test(a.docNodeKind))
                    throw new Error(
                        'The DocNode kind '.concat(JSON.stringify(a.docNodeKind), ' is not a valid identifier.') +
        ...
        (n.prototype.throwIfNotRegisteredKind = function (e) {
            if (!this._docNodeDefinitionsByKind.has(e))
                throw new Error('The DocNode kind "'.concat(e, '" was not registered with this TSDocConfiguration'));
        }),
...
var U;
(function (n) {
    ((n.Core = 'Core'), (n.Extended = 'Extended'), (n.Discretionary = 'Discretionary'), (n.None = 'None'));
})(U || (U = {}));
var R;
(function (n) {
...
var G = (function () {
    ...
    return (
        ...
        (n.alpha = n._defineTag({ tagName: '@alpha', syntaxKind: R.ModifierTag, standardization: U.Discretionary })),
        (n.beta = n._defineTag({ tagName: '@beta', syntaxKind: R.ModifierTag, standardization: U.Discretionary })),
        ...
        (n.deprecated = n._defineTag({ tagName: '@deprecated', syntaxKind: R.BlockTag, standardization: U.Core })),
        ...
        (n.inheritDoc = n._defineTag({ tagName: '@inheritDoc', syntaxKind: R.InlineTag, standardization: U.Extended })),
        (n.internal = n._defineTag({
            tagName: '@internal',
            syntaxKind: R.ModifierTag,
            standardization: U.Discretionary,
        })),
        (n.label = n._defineTag({ tagName: '@label', syntaxKind: R.InlineTag, standardization: U.Core })),
        (n.link = n._defineTag({
            tagName: '@link',
        ...
        (n.override = n._defineTag({ tagName: '@override', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        ...
        (n.public = n._defineTag({ tagName: '@public', syntaxKind: R.ModifierTag, standardization: U.Discretionary })),
        (n.readonly = n._defineTag({ tagName: '@readonly', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        (n.remarks = n._defineTag({ tagName: '@remarks', syntaxKind: R.BlockTag, standardization: U.Core })),
        (n.returns = n._defineTag({ tagName: '@returns', syntaxKind: R.BlockTag, standardization: U.Core })),
        (n.sealed = n._defineTag({ tagName: '@sealed', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        ...
        (n.virtual = n._defineTag({ tagName: '@virtual', syntaxKind: R.ModifierTag, standardization: U.Extended })),
        (n.allDefinitions = [
            n.alpha,
            n.beta,
            n.defaultValue,
...
var Mr = (function () {
    function n() {
        ((this.ignoreUndefinedTags = !1), (this.reportUnsupportedTags = !1), (this.reportUnsupportedHtmlElements = !1));
    }
    return n;
})();
var g;
    ...
    return (
        (n.register = function (e) {
            ...
            (t.registerDocNodes('@microsoft/tsdoc', [
                ...
                t.registerAllowableChildren(g.Section, [g.FencedCode, g.Paragraph, g.HtmlStartTag, g.HtmlEndTag]),
...
var Or = (function () {
    function n() {
        ((this._tagDefinitions = []),
            ...
            (this._validation = new Mr()),
            (this._docNodeManager = new Pr()),
...
var Br = (function () {
    ...
    return (
        ...
        (n.prototype.tryGetTag = function (e) {
            if (e.syntaxKind !== R.ModifierTag) throw new Error('The tag definition is not a modifier tag');
    ...
    xt = (function (n) {
        ...
        return (
            ...
            (e.prototype.appendNodeInParagraph = function (t) {
                ...
                (r || ((r = new st({ configuration: this.configuration })), this.appendNode(r)), r.appendNode(t));
            }),
...
var Ma = (function () {
    ...
    Vt = (function (n) {
        ...
        function e(t) {
            ...
            return ((r._blockTag = t.blockTag), (r._content = new xt({ configuration: r.configuration })), r);
        }
        return (
            Object.defineProperty(e.prototype, 'kind', {
                get: function () {
    ...
    Un = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'code', {
                get: function () {
                    return (this._code === void 0 && (this._code = this._codeExcerpt.content.toString()), this._code);
                },
                enumerable: !1,
                configurable: !0,
            }),
...
var Zi = (function () {
    ...
    return (
        (n.transform = function (e) {
            ...
            i.length > 0 &&
                (t.push(new Ve({ configuration: e.configuration, text: i.join('') })), (i.length = 0), (o.length = 0));
    ...
    return (
        ...
        (n.prototype._renderNode = function (e) {
            ...
            if (e !== void 0)
                switch (e.kind) {
                    ...
                    case g.BlockTag:
                        var i = e;
                        (this._lineState === he.MiddleOfLine && this._writeContent(' '), this._writeContent(i.tagName));
                        break;
                    case g.CodeSpan:
                        var o = e;
                    ...
                    case g.HtmlStartTag:
                        var b = e;
                        (this._writeContent('<'), this._writeContent(b.name), this._writeContent(b.spacingAfterName));
                        for (
                    ...
                    case g.InheritDocTag:
                        ...
                        this._renderInlineTag($, function () {
                            $.declarationReference && (t._writeContent(' '), t._renderNode($.declarationReference));
                        });
                        break;
                    case g.InlineTag:
                        var K = e;
                    ...
                    case g.MemberReference:
                        ...
                        (F.hasDot && this._writeContent('.'),
                            ...
                            F.memberSymbol ? this._renderNode(F.memberSymbol) : this._renderNode(F.memberIdentifier),
                            F.selector &&
                    ...
                    case g.Section:
                        ...
                        break;
                    case g.Paragraph:
                        var Q = Fr.trimSpacesInParagraph(e);
                        Q.nodes.length > 0 &&
        ...
        (n.prototype._writeContent = function (e) {
            if (!(e === void 0 || e.length === 0)) {
                ...
                (this._lineState === he.Closed &&
                    ...
                    this._lineState === he.StartOfLine && this._emitCommentFraming && this._output.append(' '),
        ...
        (n.prototype._writeNewline = function () {
            (this._lineState === he.Closed &&
                ...
                this._emitCommentFraming ? this._output.append(this.eol + ' *') : this._output.append(this.eol),
                (this._lineState = he.StartOfLine),
                (this._hangingParagraph = !1));
        }),
        (n.prototype._writeEnd = function () {
            (this._lineState === he.MiddleOfLine && this._emitCommentFraming && this._writeNewline(),
                this._lineState !== he.Closed &&
                    (this._emitCommentFraming && this._output.append('/' + this.eol), (this._lineState = he.Closed)));
        }),
        n
    );
})();
    ...
    Dt = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'text', {
                get: function () {
                    return (this._text === void 0 && (this._text = this._textExcerpt.content.toString()), this._text);
                },
                enumerable: !1,
                configurable: !0,
            }),
...
var Vn = (function (n) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, 'encodedText', {
            get: function () {
                return (
                    this._encodedText === void 0 && (this._encodedText = this._encodedTextExcerpt.content.toString()),
                    this._encodedText
                );
            },
            enumerable: !1,
    ...
    Jn = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'name', {
                get: function () {
                    return (this._name === void 0 && (this._name = this._nameExcerpt.content.toString()), this._name);
                },
                enumerable: !1,
                configurable: !0,
            }),
            ...
            Object.defineProperty(e.prototype, 'tagContent', {
                get: function () {
                    if (this._tagContent === void 0)
                        if (this._tagContentExcerpt) this._tagContent = this._tagContentExcerpt.content.toString();
                        else return '';
...
var Ja = (function () {
    ...
    Zn = (function (n) {
        ...
        function e(t) {
            var r = n.call(this, t) || this;
            if (r.tagNameWithUpperCase !== '@LINK') throw new Error('DocLinkTag requires the tag name to be "{@link}"');
    ...
    mn = (function (n) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, 'identifier', {
                get: function () {
                    return (
                        this._identifier === void 0 && (this._identifier = this._identifierExcerpt.content.toString()),
                        this._identifier
                    );
                },
                enumerable: !1,
            ...
            Object.defineProperty(e.prototype, 'hasQuotes', {
                get: function () {
                    return this._identifierExcerpt ? !!this._leftQuoteExcerpt : !e.isValidIdentifier(this.identifier);
                },
                enumerable: !1,
                configurable: !0,
            }),
            ...
            r._selector.length === 0
                ...
                : e._likeIndexSelectorRegExp.test(r._selector)
                  ? e._indexSelectorRegExp.test(r._selector)
                      ...
                      : (r._errorMessage = 'If the selector begins with a number, it must be a positive integer value')
...
`
        ...
        (n.prototype._validateBounds = function () {
            ...
            if (this.end < this.pos) throw new Error('TextRange.end cannot be smaller than TextRange.pos');
...
var hn = (function () {
    ...
    return (
        ...
        Object.defineProperty(n.prototype, 'text', {
            get: function () {
                return (
                    this._text === void 0 && (this._text = n._formatMessageText(this.unformattedText, this.textRange)),
                    this._text
                );
            },
            enumerable: !1,
...
var Hr = (function () {
    function n(e, t) {
        ((this.commentRange = ze.empty),
            ...
            (this.sourceRange = t),
            (this.docComment = new Gn({ configuration: this.configuration })),
            (this.log = new Lr()));
    }
    return n;
})();
                ...
                if (c >= t.end)
                    switch (d) {
                        ...
                        case pe.BeginComment2:
                            return (
                                e.log.addMessageForTextRange(v.CommentNotFound, 'Expecting a "/**" comment', t),
                                !1
                            );
                        default:
                            return (
...
`
                            ? ((d !== pe.CollectingFirstLine || l > a) && m.push(t.getNewRange(a, l)),
                              ...
                              (d = pe.AdvancingLine))
                            : _ === '*' && b === '/'
                              ? (l > a && m.push(t.getNewRange(a, l)), (a = 0), (l = 0), ++c, (o = c), (d = pe.Done))
    ...
    return (
            ...
            for (var r = t.buffer, i = t.end, o = t.pos, a = void 0, l = o; o < i; ) {
                ...
                (d === void 0 && (d = u.Other),
                    (a !== void 0 && d === a && n._isMultiCharacterToken(a)) ||
                        (a !== void 0 && e.push(new Pt(a, t.getNewRange(l, o), t)), (l = o), (a = d)),
                    ++o);
            }
        ...
        (n._ensureInitialized = function () {
            if (!n._charCodeMap) {
                ...
                ((n._charCodeMap[' '.charCodeAt(0)] = u.Spacing), (n._charCodeMap['	'.charCodeAt(0)] = u.Spacing));
            }
        }),
...
var $r = (function () {
    function n(e, t) {
        ...
        ((this._currentIndex = this._readerStartIndex), (this._accumulatedStartIndex = this._readerStartIndex));
    }
    return (
...
` + JSON.stringify(t),
        ...
        (n.prototype.peekTokenKind = function () {
            return this._currentIndex >= this._readerEndIndex ? u.EndOfInput : this.tokens[this._currentIndex].kind;
        }),
        ...
        (n.prototype.readToken = function () {
            if (this._currentIndex >= this._readerEndIndex) throw new Error('Cannot read past end of stream');
        ...
        (n.prototype.backtrackToMarker = function (e) {
            ...
            ((this._currentIndex = e), e < this._accumulatedStartIndex && (this._accumulatedStartIndex = e));
        }),
        n
    );
})();
...
var ro = (function () {
    ...
    return (
        (n.prototype.parse = function () {
            for (var e = new $r(this._parserContext), t = !1; !t; )
        ...
        (n.prototype._performValidationChecks = function () {
            ...
            (e.deprecatedBlock &&
                (cr.hasAnyTextContent(e.deprecatedBlock) ||
                ...
                e.inheritDocTag &&
                    (e.remarksBlock &&
                        this._parserContext.log.addMessageForTokenSequence(
                            ...
                            'A "'.concat(e.remarksBlock.blockTag.tagName, '" block must not be used, because that') +
                                ' content is provided by the @inheritDoc tag',
                            e.remarksBlock.blockTag.getTokenSequence(),
                            e.remarksBlock.blockTag,
                        ),
                    cr.hasAnyTextContent(e.summarySection) &&
                ...
                a !== r
                    ? r
                        ...
                        : this._parserContext.log.addMessageForTokenSequence(
                              ...
                              'The TSDoc tag "'.concat(t, '" is an inline tag; it must be enclosed in "{ }" braces'),
                              i,
                              o,
                          )
                ...
                switch (l.syntaxKind) {
                    case R.BlockTag:
                        if (a.tagNameWithUpperCase === G.param.tagNameWithUpperCase) {
                            ...
                            var d = new Vt({ configuration: this._configuration, blockTag: a });
        ...
        (n.prototype._parseParamBlock = function (e, t, r) {
            var i = e.createMarker(),
                ...
                l;
            e.peekTokenKind() === u.LeftSquareBracket && (e.readToken(), (l = e.extractAccumulatedSequence()));
            for (var c = '', d = !1; !d; )
                switch (e.peekTokenKind()) {
                    case u.AsciiWord:
                    case u.Period:
            ...
            if (m !== void 0) {
                e.backtrackToMarker(i);
                var _ = new gn({ configuration: this._configuration, blockTag: t, parameterName: '' }),
                    w =
                        c.length > 0
        ...
        (n.prototype._parseBackslashEscape = function (e) {
            ...
            return new Vn({
                parsed: !0,
                configuration: this._configuration,
                escapeStyle: sr.CommonMarkBackslash,
        ...
        (n.prototype._parseBlockTag = function (e) {
            ...
            if (e.peekTokenKind() !== u.AtSign)
                return this._backtrackAndCreateError(e, t, v.MissingTag, 'Expecting a TSDoc tag starting with "@"');
            ...
            for (var i = e.createMarker(); e.peekTokenKind() === u.AsciiWord; ) r += e.readToken().toString();
            switch (e.peekTokenKind()) {
                case u.Spacing:
                case u.Newline:
                case u.EndOfInput:
                ...
                default:
                    ...
                    return this._backtrackAndCreateError(
                        ...
                        'The token "'.concat(r, '" looks like a TSDoc tag but contains an invalid character') +
                            ' '.concat(JSON.stringify(o), '; if it is not a tag, use a backslash to escape the "@"'),
                    );
            }
        ...
        (n.prototype._parseInlineTag = function (e) {
            ...
            for (var o = e.readToken().toString(); e.peekTokenKind() === u.AsciiWord; ) o += e.readToken().toString();
            if (o === '@') {
                var a = this._createFailureForTokensSince(
                    e,
                    v.MalformedInlineTag,
            ...
            var w = e.extractAccumulatedSequence(),
                ...
                S = o.toUpperCase(),
                k = new $r(this._parserContext, _ || yt.createEmpty(this._parserContext)),
                E;
            switch (S) {
        ...
        (n.prototype._parseLinkTag = function (e, t) {
            ...
            if (t.peekTokenKind() === u.Spacing) throw new Error('Unconsumed spacing encountered after construct');
        ...
        (n.prototype._parseDeclarationReference = function (e, t, r) {
            ...
            if (o) {
                ...
                if (!e.isAccumulatedSequenceEmpty()) {
                    ...
                    if (k) {
                        this._parserContext.log.addMessageForTokenSequence(v.ReferenceMalformedImportPath, k, m, r);
                        return;
                    }
                }
        ...
        (n.prototype._parseMemberReference = function (e, t, r, i) {
            ...
            } else if (((o.memberIdentifier = this._parseMemberIdentifier(e, r, i)), !o.memberIdentifier)) return;
            if (((o.spacingAfterMemberExcerpt = this._tryReadSpacingAndNewlines(e)), e.peekTokenKind() === u.Colon)) {
                if (
                    (e.readToken(),
        ...
        (n.prototype._parseMemberIdentifier = function (e, t, r) {
            ...
            if (e.peekTokenKind() === u.DoubleQuote) {
                for (e.readToken(), i = e.extractAccumulatedSequence(); e.peekTokenKind() !== u.DoubleQuote; ) {
                ...
                if (d) {
                    this._parserContext.log.addMessageForTokenSequence(v.ReferenceUnquotedIdentifier, d, a, r);
                    return;
                }
                return new mn({
                    parsed: !0,
        ...
        (n.prototype._parseMemberSelector = function (e, t, r) {
            ...
            var i = e.readToken().toString(),
                o = e.extractAccumulatedSequence(),
                a = new tr({ parsed: !0, configuration: this._configuration, selectorExcerpt: o, selector: i });
            if (a.errorMessage) {
                this._parserContext.log.addMessageForTokenSequence(v.ReferenceSelectorSyntax, a.errorMessage, o, r);
                return;
            }
            return a;
        }),
        (n.prototype._parseHtmlStartTag = function (e) {
            ...
            if (_n(o)) return this._backtrackAndCreateErrorForFailure(e, t, 'Invalid HTML element: ', o);
            for (var a = this._tryReadSpacingAndNewlines(e), l = []; e.peekTokenKind() === u.AsciiWord; ) {
            ...
            var d = e.createMarker(),
                m = !1;
            if ((e.peekTokenKind() === u.Slash && (e.readToken(), (m = !0)), e.peekTokenKind() !== u.GreaterThan)) {
                ...
                return this._backtrackAndCreateErrorForFailure(e, t, 'The HTML tag has invalid syntax: ', _);
            }
            e.readToken();
            var w = e.extractAccumulatedSequence();
            return new Xn({
        ...
        (n.prototype._parseHtmlEndTag = function (e) {
            ...
            if (_n(a)) return this._backtrackAndCreateErrorForFailure(e, t, 'Expecting an HTML element name: ', a);
        ...
        (n.prototype._parseHtmlName = function (e) {
            ...
            if (e.peekTokenKind() === u.Spacing)
                return this._createFailureForTokensSince(e, v.MalformedHtmlName, 'A space is not allowed here', t);
            for (var r = !1; !r; )
                switch (e.peekTokenKind()) {
                    case u.Hyphen:
                    case u.Period:
            ...
            for (var a = e.tryExtractAccumulatedSequence(), l = !1, c = void 0; !l; )
                switch (e.peekTokenKind()) {
                    ...
                    case u.Backtick:
                        ...
                        return this._backtrackAndCreateErrorRangeForFailure(e, t, r, 'Error parsing code fence: ', d);
                    case u.EndOfInput:
                        ...
                        return this._backtrackAndCreateErrorRangeForFailure(e, t, r, 'Error parsing code fence: ', m);
                    default:
            ...
            for (var a = o.Start, l = 0; l < r.length; ) {
                ...
                switch (a) {
                    ...
                    case o.ReadingTrailer:
                        c || ((i = new st({ configuration: e.configuration })), t.push(i), (a = o.AwaitingTrailer));
                        break;
                }
...
var Kr = (function () {
    function n(e) {
        e ? (this.configuration = e) : (this.configuration = new Or());
    }
    return (
...
var oo = X(require('obsidian')),
    Rr = class extends oo.TFile {
        constructor(e) {
...
function os(n, e) {
    let r = new Kr().parseString(e),
        i = new Rr(n);
    return (
        (i.description = as(r.docComment.summarySection)),
        (i.returns = ss(r.docComment.returnsBlock)),
        (i.arguments = cs(r.docComment.params)),
        i
    );
}
function as(n) {
        ...
        for (let t in e)
            if (e.hasOwnProperty(t))
                if (n.hasOwnProperty(t)) {
                    ...
                    } else xn(r) && xn(i) ? pr(r, i) : i != null && i !== '' && (n[t] = i);
                } else n[t] = e[t];
    }
}
function yn(n) {
...
var go = { name: 'applyStyles', enabled: !0, phase: 'write', fn: _s, effect: xs, requires: ['computeStyles'] };
function ge(n) {
    return n.split('-')[0];
}
var qe = Math.max,
...
function Le(n) {
    for (var e = Z(n), t = ho(n); t && Wr(t) && we(t).position === 'static'; ) t = ho(t);
    return t && (me(t) === 'html' || (me(t) === 'body' && we(t).position === 'static')) ? e : t || ys(n) || e;
}
function Ft(n) {
...
function xo(n) {
    ...
    if (d) {
        ...
        if (
            (F === Z(t) &&
                ((F = Ae(t)),
                we(F).position !== 'static' && l === 'absolute' && ((J = 'scrollHeight'), (te = 'scrollWidth'))),
            (F = F),
            i === ie || ((i === ae || i === ce) && o === Ot))
        ) {
            D = ue;
    ...
    var h = Object.assign({ position: l }, d && bs),
        C = m === !0 ? Es({ x: b, y: k }, Z(t)) : { x: b, y: k };
    if (((b = C.x), (k = C.y), c)) {
        var f;
...
var yo = { name: 'computeStyles', enabled: !0, phase: 'beforeWrite', fn: Ts, data: {} };
var mr = { passive: !0 };
function ks(n) {
    var e = n.state,
        t = n.instance,
    ...
    return (
        o &&
            d.forEach(function (m) {
                m.addEventListener('scroll', t.update, mr);
            }),
        l && c.addEventListener('resize', t.update, mr),
        function () {
            (o &&
                d.forEach(function (m) {
                    m.removeEventListener('scroll', t.update, mr);
                }),
                l && c.removeEventListener('resize', t.update, mr));
        }
    );
}
var jo = { name: 'eventListeners', enabled: !0, phase: 'write', fn: function () {}, effect: ks, data: {} };
...
function hr(n) {
    return ['html', 'body', '#document'].indexOf(me(n)) >= 0 ? n.ownerDocument.body : fe(n) && $t(n) ? n : hr(ft(n));
}
function wt(n, e) {
    var t;
    e === void 0 && (e = []);
...
function Ps(n) {
    ...
    return Me(r)
        ? e.filter(function (i) {
              return Me(i) && vn(i, r) && me(i) !== 'body';
          })
        : [];
}
function Jr(n, e, t, r) {
    var i = e === 'clippingParents' ? Ps(n) : [].concat(e),
        o = [].concat(i, [t]),
        a = o[0],
        l = o.reduce(
            function (c, d) {
...
var wo = { name: 'flip', enabled: !0, phase: 'main', fn: Ms, requiresIfExists: ['offset'], data: { _skip: !1 } };
function bo(n, e, t) {
    return (
        t === void 0 && (t = { x: 0, y: 0 }),
        {
...
var To = { name: 'hide', enabled: !0, phase: 'main', requiresIfExists: ['preventOverflow'], fn: Os };
function Bs(n, e, t) {
    var r = ge(n),
        ...
        a = o[0],
        l = o[1];
    return ((a = a || 0), (l = (l || 0) * i), [ae, ce].indexOf(r) >= 0 ? { x: l, y: a } : { x: a, y: l });
}
function Is(n) {
    var e = n.state,
        t = n.options,
        ...
        i = t.offset,
        o = i === void 0 ? [0, 0] : i,
        a = dr.reduce(function (m, _) {
            return ((m[_] = Bs(_, e.rects, o)), m);
        }, {}),
        l = a[e.placement],
        c = l.x,
        d = l.y;
...
var ko = { name: 'offset', enabled: !0, phase: 'main', requires: ['popperOffsets'], fn: Is };
function Fs(n) {
    var e = n.state,
        t = n.name;
    e.modifiersData[t] = Tn({
...
var So = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Fs, data: {} };
function Xr(n) {
    return n === 'x' ? 'y' : 'x';
}
function qs(n) {
    var e = n.state,
        ...
        Q = typeof ne == 'number' ? { mainAxis: ne, altAxis: ne } : Object.assign({ mainAxis: 0, altAxis: 0 }, ne),
    ...
    if (!!F) {
        if (o) {
            var f,
                ...
                N = e.modifiersData['arrow#persistent'] ? e.modifiersData['arrow#persistent'].padding : wn(),
                q = N[Ie],
                ee = N[Ee],
                tt = qt(0, J[_e], B[_e]),
                W = K ? J[_e] / 2 - Rt - tt - q - Q.mainAxis : Ue - tt - q - Q.mainAxis,
                je = K ? -J[_e] / 2 + Rt + tt + ee + Q.mainAxis : et + tt + ee + Q.mainAxis,
...
var Co = { name: 'preventOverflow', enabled: !0, phase: 'main', fn: qs, requiresIfExists: ['offset'] };
function Zr(n) {
...
function ti(n, e, t) {
    ...
    return (
        (r || (!r && !t)) &&
            ...
            fe(e) ? ((c = Oe(e, !0)), (c.x += e.clientLeft), (c.y += e.clientTop)) : o && (c.x = Ht(o))),
            ...
            b = {
                ...
                setOptions: function (O) {
                    ...
                    (k(),
                        ...
                        (m.scrollParents = {
                            reference: Me(l) ? wt(l) : l.contextElement ? wt(l.contextElement) : [],
                            popper: wt(c),
                        }));
                ...
                forceUpdate: function () {
                    if (!w) {
                        var O = m.elements,
                            ...
                            K = O.popper;
                        if (!!Po($, K)) {
                            ((m.rects = { reference: ti($, Le(K), m.options.strategy === 'fixed'), popper: It(K) }),
                                (m.reset = !1),
...
var $s = [jo, So, yo, go, ko, wo, Co, _o, To],
    oi = No({ defaultModifiers: $s });
var Ks = (n, e) => ((n % e) + e) % e,
    Oo = class {
        constructor(e, t, r) {
            ((this.owner = e),
        ...
        setSelectedItem(e, t) {
            let r = Ks(e, this.suggestions.length),
    ...
    kn = class {
        ...
        open(e, t) {
            (this.app.keymap.pushScope(this.scope),
                ...
                (this.popper = oi(t, this.suggestEl, {
...
var on = class extends kn {
    ...
    getSuggestions(e) {
        let t = Ce(() => Je(this.plugin.app, this.get_folder(this.mode)), this.get_error_msg(this.mode));
        if (!t) return [];
        let r = [],
            i = e.toLowerCase();
        return (
            t.forEach((o) => {
                o instanceof Bo.TFile && o.extension === 'md' && o.path.toLowerCase().contains(i) && r.push(o);
            }),
            r.slice(0, 1e3)
        );
    }
...
var Ho = {
    ...
    ai = class extends L.PluginSettingTab {
        constructor(e) {
            super(e.app, e);
            this.plugin = e;
        }
        ...
        add_internal_functions_setting() {
            ...
            (e.append(
                ...
                e.createEl('br'),
                'Check the ',
                e.createEl('a', { href: 'https://silentvoid13.github.io/Templater/', text: 'documentation' }),
                    ...
                    new L.Setting(this.containerEl)
                        ...
                        .addExtraButton((o) => {
                            o.setIcon('up-chevron-glyph')
                                .setTooltip('Move up')
                                .onClick(() => {
                                    (Mt(this.plugin.settings.enabled_templates_hotkeys, r, r - 1),
                                        this.plugin.save_settings(),
                                        this.display());
                                });
                        })
        ...
        add_user_script_functions_setting() {
                ...
                new L.Setting(this.containerEl)
                    ...
                    .addDropdown((r) => {
                        r.addOption('0', 'Turn off intellisense')
                            ...
                            .onChange((i) => {
                                ((this.plugin.settings.intellisense_render = parseInt(i)), this.plugin.save_settings());
                            });
                    }),
            ...
            if (!this.plugin.settings.user_scripts_folder) t = 'No user scripts folder set';
                ...
                if (!r || r.length === 0) t = 'No user scripts detected';
                    ...
                    let i = 0;
                    for (let o of r)
                        o.extension === 'js' && (i++, e.append(e.createEl('li', { text: `tp.user.${o.basename}` })));
        ...
        add_donating_setting() {
            ...
            (t.setAttribute('href', 'https://github.com/sponsors/silentvoid13'), t.addClass('templater_donating'));
            let r = document.createElement('img');
            ((r.src = 'https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86'),
                t.appendChild(r));
...
var an;
(function (t) {
    ((t[(t.InsertTemplate = 0)] = 'InsertTemplate'), (t[(t.CreateNoteTemplate = 1)] = 'CreateNoteTemplate'));
})(an || (an = {}));
var si = class extends Ar.FuzzySuggestModal {
    ...
    getItemText(e) {
        ...
        if (
            ...
            (0, Ar.normalizePath)(this.plugin.settings.templates_folder) != '/'
        ) {
...
var be = class {
    ...
    async init() {
        (await this.create_static_templates(), (this.static_object = Object.fromEntries(this.static_functions)));
    }
    ...
    generate_now() {
        return (e = 'YYYY-MM-DD', t, r, i) => {
            if (r && !(0, mt.moment)(r, i).isValid())
                throw new P("Invalid reference date format, try specifying one with the argument 'reference_format'");
            let o;
            return (
                typeof t == 'string'
...
var Ro = 10,
    li = class extends be {
        ...
        generate_creation_date() {
            return (e = 'YYYY-MM-DD HH:mm') => (0, le.moment)(this.config.target_file.stat.ctime).format(e);
        }
        generate_cursor() {
        ...
        generate_last_modified_date() {
            return (e = 'YYYY-MM-DD HH:mm') => (0, le.moment)(this.config.target_file.stat.mtime).format(e);
        }
        generate_move() {
            return async (e, t) => {
                ...
                if ((o.pop(), o.length)) {
                    let a = o.join('/');
                    this.plugin.app.vault.getAbstractFileByPath(a) || (await this.plugin.app.vault.createFolder(a));
                }
        ...
        generate_rename() {
            return async (e) => {
                if (e.match(/[\\/:]+/g)) throw new P('File name cannot contain any of these characters: \\ / :');
...
> \u2014 ${o}`;
    ...
    generate_random_picture() {
        return async (e, t, r = !1) => {
            try {
                let i = await this.getRequest(`https://templater-unsplash-2.fly.dev/${t ? '?q=' + t : ''}`).then(
                        (a) => a.json,
                    ),
                    o = i.full;
                if (e && !r)
...
var Uo = X(require('obsidian')),
    mi = class extends Uo.FuzzySuggestModal {
...
var hi = class extends be {
    ...
    generate_prompt() {
        return async (e, t, r = !1, i = !1) => {
            let o = new di(this.plugin.app, e, t, i),
    ...
    generate_suggester() {
        return async (e, t, r = !1, i = '', o) => {
            let a = new mi(this.plugin.app, e, t, i, o),
...
var _i = class {
    constructor(e) {
        ...
        (this.modules_array.push(new ci(this.plugin)),
            ...
            this.modules_array.push(new hi(this.plugin)),
...
var Cn = X(require('obsidian'));
var xi = class {
    constructor(e) {
        this.plugin = e;
        if (Cn.Platform.isMobile || !(this.plugin.app.vault.adapter instanceof Cn.FileSystemAdapter)) this.cwd = '';
        else {
...
var yi = class {
    ...
    async generate_user_script_functions() {
        ...
        if (!t) return new Map();
        for (let r of t) r.extension.toLowerCase() === 'js' && (await this.load_user_script_function(r, e));
        return e;
    }
...
var ji = class {
    constructor(e) {
        this.plugin = e;
        ((this.user_system_functions = new xi(e)), (this.user_script_functions = new yi(e)));
    }
    async generate_object(e) {
        let t = {},
            r = {};
        return (
            this.plugin.settings.enable_system_commands && (t = await this.user_system_functions.generate_object(e)),
            this.plugin.settings.user_scripts_folder && (r = await this.user_script_functions.generate_object()),
            { ...t, ...r }
        );
    }
};
var Rs = X(require('obsidian')),
    Xe;
(function (t) {
...
var vi = class {
    constructor(e) {
        this.plugin = e;
        ((this.internal_functions = new _i(this.plugin)), (this.user_functions = new ji(this.plugin)));
    }
    async init() {
    ...
    additional_functions() {
        return { app: this.plugin.app, obsidian: Rs };
    }
...
var Re = 0,
    yr = new TextEncoder('utf-8'),
    Us =
        typeof yr.encodeInto == 'function'
            ? function (n, e) {
                  return yr.encodeInto(n, e);
              }
            : function (n, e) {
                  let t = yr.encode(n);
...
var jr = new Int32Array();
function Ne() {
    return (jr.byteLength === 0 && (jr = new Int32Array(M.memory.buffer)), jr);
}
function bi(n) {
    let e = typeof n;
...
var vr = 32;
function Vs(n) {
    if (vr == 1) throw new Error('out of js stack');
    return ((Ke[--vr] = n), vr);
}
function Ei(n, e) {
    try {
        ...
        render_content(e, t) {
            try {
                let a = M.__wbindgen_add_to_stack_pointer(-16),
                    ...
                    c = Re;
                M.renderer_render_content(a, this.ptr, l, c, Vs(t));
                var r = Ne()[a / 4 + 0],
                    i = Ne()[a / 4 + 1],
                    o = Ne()[a / 4 + 2];
                if (o) throw wi(i);
                ...
                (M.__wbindgen_add_to_stack_pointer(16), (Ke[vr++] = void 0));
            }
        }
    };
...
function Js() {
    ...
    return (
        ...
        (n.wbg.__wbindgen_string_get = function (e, t) {
            ...
            var o = Gs(i) ? 0 : gt(i, M.__wbindgen_malloc, M.__wbindgen_realloc),
                a = Re;
...
function Qs(n, e) {}
function Xs(n, e) {
    return ((M = n.exports), (Vo.__wbindgen_wasm_module = e), (jr = new Int32Array()), (_r = new Uint8Array()), M);
}
async function Vo(n) {
    typeof n == 'undefined' && (n = new URL('rusty_engine_bg.wasm', Zs.url));
    let e = Js();
    ((typeof n == 'string' ||
        ...
        (n = fetch(n)),
        Qs(e));
    let { instance: t, module: r } = await zs(await n, e);
    return Xs(t, r);
}
var zo = Vo;
var Jo = zi(
...
var Pn = class {
    constructor(e) {
        this.plugin = e;
        ((this.functions_generator = new vi(this.plugin)), (this.parser = new Ti()));
    }
    async setup() {
    ...
    async create_new_note_from_template(e, t, r, i = !0) {
        ...
        if (
            (e instanceof de.TFile
                ? ((c = this.create_running_config(e, a, 0)),
                  (d = await Se(async () => this.read_and_parse_template(c), 'Template parsing error, aborting.')))
                : ((c = this.create_running_config(void 0, a, 0)),
                  (d = await Se(async () => this.parse_template(c, e), 'Template parsing error, aborting.'))),
            d == null)
        ) {
        ...
        if (
            ...
            this.plugin.app.workspace.trigger('templater:new-note-from-template', { file: a, content: d }),
            i)
        ) {
    ...
    async append_template_to_active_file(e) {
        ...
        let o = this.create_running_config(e, r.file, 1),
            a = await Se(async () => this.read_and_parse_template(o), 'Template parsing error, aborting.');
        if (a == null) {
            await this.end_templater_task(i);
            return;
        }
        let { content: l, frontmatter: c } = yn(a),
            m = r.editor.getDoc(),
            _ = m.listSelections();
    ...
    async write_template_to_file(e, t) {
        ...
        let i = this.plugin.app.workspace.getActiveViewOfType(de.MarkdownView),
            ...
            c = await Se(async () => this.read_and_parse_template(l), 'Template parsing error, aborting.');
        if (c == null) {
            await this.end_templater_task(r);
            return;
        }
        let { content: d, frontmatter: m } = yn(c);
        if (a?.path === t.path && o && o.editor && i) {
            let _ = '',
                { content: w, frontmatter: b } = yn(o.editor.getValue());
            (pr(b, m),
...
`),
    ...
    async overwrite_file_commands(e, t = !1) {
        ...
        let i = this.create_running_config(e, e, t ? 3 : 2),
            o = await Se(async () => this.read_and_parse_template(i), 'Template parsing error, aborting.');
        if (o == null) {
            await this.end_templater_task(r);
            return;
        }
    ...
    static async on_file_creation(e, t, r) {
        ...
        if ((r.path.includes(i) && i !== '/') || (await jt(300), e.files_with_pending_templates.has(r.path))) return;
    ...
    async execute_startup_scripts() {
        for (let e of this.plugin.settings.startup_templates) {
            if (!e) continue;
            let t = Ce(() => Nt(this.plugin.app, e), `Couldn't find startup template "${e}"`);
            if (!t) continue;
            let { path: r } = t;
            this.start_templater_task(r);
            let i = this.create_running_config(t, t, 5);
            (await Se(async () => this.read_and_parse_template(i), 'Startup Template parsing error, aborting.'),
                await this.end_templater_task(r));
        }
    }
};
var Qo = X(require('obsidian')),
    wr = class {
        constructor(e, t, r) {
            this.plugin = e;
            this.templater = t;
        ...
        update_trigger_file_on_creation() {
            this.settings.trigger_on_file_creation
                ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on('create', (e) =>
                      Pn.on_file_creation(this.templater, this.plugin.app, e),
                  )),
...
var ki = class {
    ...
    setup() {
        (this.plugin.addCommand({
            ...
            icon: 'templater-icon',
            hotkeys: br.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'e' }],
            callback: () => {
            ...
            this.plugin.addCommand({
                ...
                icon: 'templater-icon',
                hotkeys: br.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'r' }],
                callback: () => {
            ...
            this.plugin.addCommand({
                ...
                icon: 'templater-icon',
                hotkeys: br.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'n' }],
                callback: () => {
    ...
    add_template_hotkey(e, t) {
        if ((this.remove_template_hotkey(e), t)) {
            let r = t.slice(this.plugin.settings.templates_folder.length + 1, -3);
            (this.plugin.addCommand({
                id: t,
                name: `Insert ${r}`,
                icon: 'templater-icon',
...
var Mi = X(require('obsidian'));
var Si = X(require('obsidian'));
var Ci = class {
    constructor(e) {
        this.app = e;
    }
    async jump_to_next_cursor_location() {
        ...
        let t = e.editor.getValue(),
            { new_content: r, positions: i } = this.replace_and_get_cursor_positions(t);
        if (i) {
            let o = e instanceof Si.MarkdownView ? e.currentMode.getFoldInfo() : null;
            (e.editor.setValue(r),
                o &&
                    ...
                    e instanceof Si.MarkdownView && (e.currentMode.applyFoldInfo(o), await jt(100), e.save())),
        ...
        try {
            ...
            console.warn('Templater: Failed to enter insert mode for vim users.', o);
        }
    }
...
`,
    ...
    replace_and_get_cursor_positions(e) {
        ...
        t.sort((c, d) => Number(c.groups && c.groups.order) - Number(d.groups && d.groups.order));
        let o = t[0][0];
        t = t.filter((c) => c[0] === o);
        let a = [],
            l = 0;
...
`,
        ...
        date: {
            ...
            functions: {
                now: {
                    ...
                    args: [
                        ...
                        { name: 'reference', description: "The date referential, e.g. set this to the note's title." },
                        {
                ...
                tomorrow: {
                    ...
                    examples: [
                        ...
                        { name: 'Date tomorrow with format', example: '<% tp.date.tomorrow("Do MMMM YYYY") %>' },
                    ],
                },
                yesterday: {
                    name: 'yesterday',
                    ...
                    examples: [
                        ...
                        { name: 'Date yesterday with format', example: '<% tp.date.yesterday("Do MMMM YYYY") %>' },
                    ],
                },
                weekday: {
                    name: 'weekday',
            ...
            momentjs: {
                examples: [
                    { name: 'Date now', example: '<% moment(tp.file.title, "YYYY-MM-DD").format("YYYY-MM-DD") %>' },
                    {
            ...
            functions: {
                ...
                create_new: {
                    ...
                    args: [
                        ...
                        { name: 'filename', description: 'The filename of the new file, defaults to "Untitled".' },
                        {
                            name: 'open_new',
                            description:
...
`,
                    ...
                    examples: [
                        ...
                        { name: 'File multi-cursor', example: '<% tp.file.cursor(1) %>Content<% tp.file.cursor(1) %>' },
                    ],
                },
                cursor_append: {
                    name: 'cursor_append',
                    ...
                    args: [{ name: 'content', description: 'The content to append after the active cursor.' }],
                    examples: [{ name: 'File cursor append', example: '<% tp.file.cursor_append("Some text") %>' }],
                },
                exists: {
                    name: 'exists',
                    description:
                ...
                find_tfile: {
                    ...
                    args: [
                        { name: 'filename', description: 'The filename we want to search and resolve as a `TFile`.' },
                    ],
                    examples: [{ name: 'File find TFile', example: '<% tp.file.find_tfile("MyFile").basename %>' }],
                },
                folder: {
                    name: 'folder',
                ...
                include: {
                    ...
                    examples: [
                        ...
                        { name: 'File include section', example: '<% await tp.file.include("[[MyFile#Section1]]") %>' },
                        { name: 'File include block', example: '<% await tp.file.include("[[MyFile#^block1]]") %>' },
                    ],
                },
                last_modified_date: {
                ...
                move: {
                    ...
                    args: [
                        ...
                        { name: 'file_to_move', description: 'The file to move, defaults to the current file.' },
                    ],
                    examples: [
                ...
                path: {
                    ...
                    examples: [
                        ...
                        { name: 'File relative path (relative to vault root)', example: '<% tp.file.path(true) %>' },
                    ],
                },
                rename: {
                    name: 'rename',
...
selected values: <% selectedValues %>`,
            ...
            functions: {
                ...
                random_picture: {
                    ...
                    examples: [
                        ...
                        { name: 'Random picture with size', example: '<% await tp.web.random_picture("200x200") %>' },
                        {
                ...
                request: {
                    ...
                    args: [
                        ...
                        { name: 'path', description: 'A path within the response JSON to extract specific data.' },
                    ],
                    examples: [
                        {
                            name: 'Simple request',
    ...
    Zo = { tp: tc };
var nc = ['app', 'config', 'date', 'file', 'frontmatter', 'hooks', 'obsidian', 'system', 'user', 'web'],
    rc = new Set(nc);
function ea(n) {
    return typeof n == 'string' && rc.has(n);
}
function Di(n) {
...
var Pi = class {
    ...
    async get_all_functions_documentation(e, t) {
        ...
        if (!!this.documentation.tp[e].functions)
            return Object.values(this.documentation.tp[e].functions).map((r) => ((r.queryKey = r.name), r));
    }
...
var Ni = class extends ta.EditorSuggest {
    constructor(e) {
        super(e.app);
        this.tp_keyword_regex = /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-zA-Z_.]*)?)?$/;
        ((this.documentation = new Pi(e)), (this.intellisense_render_setting = e.settings.intellisense_render));
    }
    onTrigger(e, t, r) {
        ...
        if (((this.module_name = l), o.groups && o.groups.fn_trigger)) {
            ...
            ((this.function_trigger = !0), (this.function_name = o.groups.fn || ''), (a = this.function_name));
        } else ((this.function_trigger = !1), (a = this.module_name));
        let c = { start: { line: e.line, ch: e.ch - a.length }, end: { line: e.line, ch: e.ch }, query: a };
    ...
    async getSuggestions(e) {
        ...
        return (
            this.module_name && this.function_trigger
                ? (t = await this.documentation.get_all_functions_documentation(this.module_name, this.function_name))
                : (t = this.documentation.get_all_modules_documentation()),
            t ? t.filter((r) => r.queryKey.toLowerCase().startsWith(e.query.toLowerCase())) : []
        );
    }
    renderSuggestion(e, t) {
        if ((t.createEl('b', { text: e.name }), Di(e))) {
            if (e.args && this.getNumberOfArguments(e.args) > 0 && qo(this.intellisense_render_setting)) {
                t.createEl('p', { text: 'Parameter list:' });
                let r = t.createEl('ol');
                for (let [i, o] of Object.entries(e.args)) Ur(r, i, o.description);
            }
            e.returns && Fo(this.intellisense_render_setting) && Ur(t, 'Returns', e.returns);
        }
        (this.function_trigger && Di(e) && t.createEl('code', { text: e.definition }),
            e.description && Lo(this.intellisense_render_setting) && t.createEl('div', { text: e.description }));
    }
    selectSuggestion(e, t) {
        let r = this.app.workspace.activeEditor;
        if (
            !(!r || !r.editor) &&
            (r.editor.replaceRange(e.queryKey, this.latest_trigger_info.start, this.latest_trigger_info.end),
...
(function (n) {
    ...
    (n.defineMode('javascript', function (e, t) {
        ...
        function O(s, p) {
            ...
            if (A == '0' && s.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return E('number', 'number');
            if (/\d/.test(A))
            ...
            if ((A == '<' && s.match('!--')) || (A == '-' && s.match('->') && !/\S/.test(s.string.slice(0, s.start))))
        ...
        function $(s) {
            return function (p, A) {
                var x = !1,
                    I;
                if (o && p.peek() == '@' && p.match(w)) return ((A.tokenize = O), E('jsonld-keyword', 'meta'));
            ...
            if (!(A < 0)) {
                ...
                for (var I = 0, Y = !1, z = A - 1; z >= 0; --z) {
                    ...
                    if (We >= 0 && We < 3) {
                        ...
                        for (; ; --z) {
                            if (z == 0) return;
                            var ja = s.string.charAt(z - 1);
                            if (ja == ve && s.string.charAt(z - 2) != '\\') {
                                z--;
                                break;
                            }
                        }
        ...
        function Ue() {
            ((h.state.context = new Ye(h.state.context, h.state.localVars, !1)), (h.state.localVars = Rt));
        }
        function et() {
            ((h.state.context = new Ye(h.state.context, h.state.localVars, !0)), (h.state.localVars = null));
        }
        function ye() {
                          ...
                          : s == ';'
                            ...
                            : s == 'if'
                              ...
                              : s == 'function'
                                ? f(_t)
                                : s == 'for'
                                  ? f(B('form'), et, $i, ee, ye, N)
                                  : s == 'class' || (c && p == 'interface')
                                    ? ((h.marked = 'keyword'), f(B('form', s == 'class' ? s : p), Ri, N))
                                    : s == 'variable'
                                      ? c && p == 'declare'
                                          ...
                                          : c &&
                                            ...
                                            : c && p == 'namespace'
                                              ...
                                              : c && p == 'abstract'
                                                ...
                                                : f(B('stat'), Fn)
                                      : s == 'switch'
                                        ? f(B('form'), Tt, q('{'), B('}', 'switch'), et, Ln, N, N, ye)
                                        : s == 'case'
                                          ? f(W, q(':'))
                                          : s == 'default'
                                            ? f(q(':'))
        ...
        function Nn(s, p, A) {
            ...
            return J.hasOwnProperty(s)
                ...
                : s == 'function'
                  ? f(_t, I)
                  : s == 'class' || (c && p == 'interface')
                    ? ((h.marked = 'keyword'), f(B('form'), ma, N))
                    : s == 'keyword c' || s == 'async'
                      ? f(A ? je : W)
                      : s == '('
                        ? f(B(')'), nt, q(')'), N, I)
        ...
        function kt(s, p) {
            return s != 'quasi' ? C() : p.slice(p.length - 2) != '${' ? f(kt) : f(nt, Mn);
        }
        function Mn(s) {
            if (s == '}') return ((h.marked = 'string-2'), (h.state.tokenize = D), f(kt));
        }
        function On(s) {
        ...
        function it(s) {
            return function (p) {
                return p == '.' ? f(s ? In : Yt) : p == 'variable' && c ? f(la, s ? ht : rt) : C(s ? je : W);
            };
        }
        function Yt(s, p) {
        ...
        function St(s, p) {
            ...
            if (s == 'variable' || h.style == 'keyword') {
                ...
                if (s == 'number' || s == 'string') return ((h.marked = o ? 'property' : h.style + ' property'), f(Ge));
        ...
        function qi(s) {
            if (c && s == ':') return h.stream.match(/^\s*\w+\s+is\b/, !1) ? f(W, aa, V) : f(V);
        }
        function aa(s, p) {
        ...
        function V(s, p) {
            ...
            if (s == '{') return f(B('}'), Tr, N, ot);
            if (s == '(') return f(se(Sr, ')'), sa, ot);
            if (s == '<') return f(se(V, '>'), V);
            if (s == 'quasi') return C(kr, ot);
        }
        function sa(s) {
            if (s == '=>') return f(V);
        }
        function Tr(s) {
            return s.match(/[\}\)\]]/) ? f() : s == ',' || s == ';' ? f(Tr) : C(pn, Tr);
        }
        function pn(s, p) {
            if (s == 'variable' || h.style == 'keyword') return ((h.marked = 'property'), f(pn));
        ...
        function kr(s, p) {
            return s != 'quasi' ? C() : p.slice(p.length - 2) != '${' ? f(kr) : f(V, ca);
        }
        function ca(s) {
            if (s == '}') return ((h.marked = 'string-2'), (h.state.tokenize = D), f(kr));
        }
        function Sr(s, p) {
        ...
        function Li(s, p) {
            return s == 'variable' && !h.stream.match(/^\s*:/, !1)
                ...
                : (s == 'variable' && (h.marked = 'property'),
                  s == 'spread' ? f(Fe) : s == '}' ? C() : s == '[' ? f(W, q(']'), q(':'), Li) : f(q(':'), Fe, At));
        }
        function ua() {
            return C(Fe, At);
        }
        ...
        function ma(s, p) {
            return s == 'variable' ? Ri(s, p) : $n(s, p);
        }
        function Ri(s, p) {
            if (s == 'variable') return (Ee(p), f($n));
        }
        function $n(s, p) {
            if (p == '<') return f(B('>'), se(Hn, '>'), N, $n);
            if (p == 'extends' || p == 'implements' || (c && s == ','))
                return (p == 'implements' && (h.marked = 'keyword'), f(c ? V : W, $n));
        ...
        function at(s, p) {
            ...
            if (s == 'variable' || h.style == 'keyword') return ((h.marked = 'property'), f(un, at));
        ...
        function Yi(s, p) {
            ...
            if (s == 'variable') return C(je, Yi);
        }
        function ha(s) {
            return s == 'string' ? f() : s == '(' ? C(W) : s == '.' ? C(rt) : C(Kn, Ui, Dr);
        }
        function Kn(s, p) {
            return s == '{' ? ln(Kn, '}') : (s == 'variable' && Ee(p), p == '*' && (h.marked = 'keyword'), f(Aa));
        }
        function Ui(s) {
            if (s == ',') return f(Kn, Ui);
        }
        function Aa(s, p) {
            if (p == 'as') return ((h.marked = 'keyword'), f(Kn));
        }
        function Dr(s, p) {
        ...
        function Gi() {
            return C(B('form'), Fe, q('{'), B('}'), se(xa, '}'), N, N);
        }
        function xa() {
            return C(Fe, At);
        }
        function ya(s, p) {
            return s.lastType == 'operator' || s.lastType == ',' || _.test(p.charAt(0)) || /[,.]/.test(p.charAt(0));
        }
        function Wi(s, p, A) {
            return (
                (p.tokenize == O &&
        ...
        return {
            ...
            token: function (s, p) {
                ...
                return S == 'comment'
                    ? A
                    : ((p.lastType = S == 'operator' && (k == '++' || k == '--') ? 'incdec' : S), Q(p, A, S, k, s));
            },
            indent: function (s, p) {
                ...
                if (!/^\s*else\b/.test(p))
                    for (var Y = s.cc.length - 1; Y >= 0; --Y) {
                        var z = s.cc[Y];
                        if (z == N) x = x.prev;
                        else if (z != Hi && z != ye) break;
                    }
                for (
                    ;
                    (x.type == 'stat' || x.type == 'form') &&
                    (A == '}' || ((I = s.cc[s.cc.length - 1]) && (I == rt || I == ht) && !/^[,\.=+\-*:?[\(]/.test(p)));
                )
                    x = x.prev;
        ...
        return {
            ...
            token: function (i, o) {
                return (
                    ...
                    o.overlayCur == null
                        ? o.baseCur
                        : (o.baseCur != null && o.overlay.combineTokens) || (r && o.overlay.combineTokens == null)
...
var na = X(require('@codemirror/language')),
    ra = X(require('@codemirror/state')),
    ia = 'templater',
    Oi = 'templater-command',
    Bi = 'templater-inline',
    ic = 'templater-opening-tag',
    oc = 'templater-closing-tag',
    ac = 'templater-interpolation-tag',
    sc = 'templater-execution-tag',
    Ii = class {
        constructor(e) {
            this.plugin = e;
            ((this.cursor_jumper = new Ci(e.app)), (this.activeEditorExtensions = []));
        }
        desktopShouldHighlight() {
            return Mi.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting;
        }
        mobileShouldHighlight() {
            return Mi.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile;
        }
        async setup() {
            ((this.autocomplete = new Ni(this.plugin)),
                this.plugin.registerEditorSuggest(this.autocomplete),
                await this.registerCodeMirrorMode(),
                (this.templaterLanguage = ra.Prec.high(na.StreamLanguage.define(window.CodeMirror.getMode({}, ia)))),
                ...
                (this.desktopShouldHighlight() || this.mobileShouldHighlight()) && (await this.enable_highlighter()));
        }
        async enable_highlighter() {
            this.activeEditorExtensions.length === 0 &&
                this.templaterLanguage &&
                (this.activeEditorExtensions.push(this.templaterLanguage), this.plugin.app.workspace.updateOptions());
        }
        ...
        async registerCodeMirrorMode() {
            ...
            window.CodeMirror.defineMode(ia, function (r) {
                let i = {
                    startState: function () {
                        return { ...window.CodeMirror.startState(e), inCommand: !1, tag_class: '', freeLine: !1 };
                    },
                    ...
                    token: function (o, a) {
                        ...
                        if (l != null) {
                            ...
                            return ((a.inCommand = !0), `line-${Bi} ${Oi} ${ic} ${a.tag_class}`);
                        }
...
var Fi = class extends Er.Plugin {
    async onload() {
        (await this.load_settings(),
            (this.templater = new Pn(this)),
            await this.templater.setup(),
            (this.editor_handler = new Ii(this)),
            await this.editor_handler.setup(),
            (this.fuzzy_suggester = new si(this)),
            (this.event_handler = new wr(this, this.templater, this.settings)),
            this.event_handler.setup(),
            (this.command_handler = new ki(this)),
            this.command_handler.setup(),
            (0, Er.addIcon)('templater-icon', Ko),
            this.addRibbonIcon('templater-icon', 'Templater', async () => {
                this.fuzzy_suggester.insert_template();
            }).setAttribute('id', 'rb-templater-icon'),
            this.addSettingTab(new ai(this)),
