...
var MomentDateRegex = /** @class */ (function () {
    ...
    MomentDateRegex.prototype.replace = function (input) {
        ...
        var formattedDates = matches.map(function (m) {
            ...
            return [m.groups.target, _this.getMoment(now, dateFormat)];
        });
...
var NoteRefactorSettingsTab = /** @class */ (function (_super) {
    ...
    NoteRefactorSettingsTab.prototype.display = function () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addTextArea(function (text) {
                text.setPlaceholder('Example: {{date:YYYYMMDDHHmm}}-')
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                this.tempalteDescriptionContent(
                    'The template used to generate the link to the extracted note. This overrides the Transclude by Default setting.',
                ),
            )
            .addTextArea(function (text) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                this.tempalteDescriptionContent('The template used to generate the content for the refactored note.'),
            )
            .addTextArea(function (text) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                'Prevent the first line of selected/split note content from being included in the new note (only applies for first line as file name commands)',
            )
            .addToggle(function (toggle) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                'Include first line of selected/split note content as note heading (applies for both first line as title and content only commands)',
            )
            .addToggle(function (toggle) {
...
var NRFile = /** @class */ (function () {
    ...
    NRFile.prototype.ensureUniqueFileNames = function (headingNotes) {
        ...
        var deduped = headingNotes.map(function (hn) {
            ...
            var duplicates = fileNames.filter(function (fn) {
                return fn == fileName;
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 6];
                    case 3:
                        return [4 /*yield*/, this.vault.createFolder(newFolderPath)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.createFoldersFromVaultRoot(newFolderPath, folders)];
                    case 5:
...
var Placeholder = /** @class */ (function () {
    ...
    Placeholder.prototype.replace = function (input, value) {
        return input.replace(new RegExp('{{'.concat(this.key, '}}'), 'gmi'), function () {
            return value;
        });
    };
    return Placeholder;
...
var NRDoc = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            this.vault.getMarkdownFiles().filter(function (f) {
    ...
    NRDoc.prototype.templatedContent = function (
        input,
        template,
        currentNoteTitle,
        currentNoteLink,
    ...
    NRDoc.prototype.normalizeHeadingLevels = function (contentArr) {
        var _this = this;
        var minHeadingLevel = Math.min.apply(
            Math,
            contentArr
                .map(function (line) {
                    return _this.headingLevel(line);
                })
    ...
    NoteRefactorModal.prototype.getItems = function () {
        ...
        if (
            ...
            this.files.filter(function (f) {
                return _this.isMatch(f.path, inputName + '.md');
            }).length > 0
        ) {
            return this.files;
        }
        var newFile = {
            basename: this.inputEl.value,
            path: undefined,
            stat: undefined,
            vault: undefined,
            extension: undefined,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.templatedContent(this.content, currentFile, file.path, file.basename),
                        ];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [
                            2 /*return*/,
                            this.doc.templatedContent(
                                note,
                                this.settings.refactoredNoteTemplate,
                                curerntFile.basename,
                                currentFileLink,
                                fileName,
                                fileLink,
                                '',
...
var NoteRefactor = /** @class */ (function (_super) {
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.editModeGuard(function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    return [
                                                        4 /*yield*/,
                                                        this.extractSelectionFirstLine('replace-selection'),
                                                    ];
                                                case 1:
                        ...
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.editModeGuard(function () {
                                    return _this.extractSelectionContentOnly('replace-selection');
                                });
                            },
                            hotkeys: [
                                {
                        ...
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.editModeGuard(function () {
                                    return _this.extractSelectionAutogenerate('replace-selection');
                                });
                            },
                        });
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.editModeGuard(function () {
                                    return _this.extractSelectionFirstLine('split');
                                });
                            },
                        });
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.editModeGuard(function () {
                                    return _this.extractSelectionContentOnly('split');
                                });
                            },
                        });
                        this.addCommand({
    ...
    NoteRefactor.prototype.splitOnHeading = function (headingLevel) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                headingNotes.forEach(function (hn, i) {
                    return _this.createNoteWithFirstLineAsFileName(
                        dedupedFileNames[i],
                        hn,
                        mdView,
                        doc,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        selectedContent =
                            mode === 'split' ? this.NRDoc.noteRemainder(doc) : this.NRDoc.selectedContent(doc);
                        if (selectedContent.length <= 0) {
                            return [2 /*return*/];
                        }
                        return [
                            4 /*yield*/,
                            this.createNoteWithFirstLineAsFileName(
                                selectedContent[0],
                                selectedContent,
                                mdView,
                                doc,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.createAutogeneratedNote(selectedContent, mdView, doc, mode, true)];
                    case 1:
                        _a.sent(); // Don't open a new note in a new pane. TODO: perhaps a setting would be useful?
                        return [2 /*return*/];
                }
            });
        });
    };
    NoteRefactor.prototype.createAutogeneratedNote = function (selectedContent, mdView, doc, mode, isMultiple) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fileName = this.file.fileNamePrefix();
                    ...
                    case 1:
                        ...
                        if (
                            ...
                            return [3 /*break*/, 4];
                        return [4 /*yield*/, this.app.fileManager.generateMarkdownLink(mdView.file, '', '', '')];
                    case 2:
                        link = _a.sent();
                    ...
                    case 5:
                        ...
                        return [
                            4 /*yield*/,
                            this.NRDoc.replaceContent(fileName, filePath, doc, mdView.file, note, originalNote, mode),
                        ];
                    case 6:
                        _a.sent();
    ...
    NoteRefactor.prototype.createNoteWithFirstLineAsFileName = function (
        dedupedHeader,
        selectedContent,
        mdView,
        doc,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ((originalHeader = selectedContent[0]), (contentArr = selectedContent.slice(1)));
    ...
    NoteRefactor.prototype.loadModal = function (contentArr, doc, mode) {
        ...
        var modalCreation = new ModalNoteCreation(
            this.app,
            this.settings,
            this.NRDoc,
            this.file,
