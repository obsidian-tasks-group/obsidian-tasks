...
4. The  `Tasks-Demo` vault, in `resources/sample_vaults/Tasks-Demo/` has an up-to-date build of the Tasks plugin: see [[Local development#Quick start|Quick start]].
